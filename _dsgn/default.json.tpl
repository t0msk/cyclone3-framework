...
<template>
	...
	<entity id="page.error" replace_variables="false"><![CDATA[{ "success": false, "errors": { "reason": "<$main::FORM{'TID'}>: <!--ERROR-->" }}]]>
	</entity>
	
	
	<entity id="page.warning" replace_L10n="true" replace_variables="false"><![CDATA[{ "success": false, "errors": { "reason": "<$main::FORM{'TID'}>: <%message%>" }}]]></entity>
