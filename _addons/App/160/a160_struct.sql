...
CREATE TABLE `/*db_name*/`.`/*addon*/_relation` (
  ...
  `rel_type` varchar(32) character set utf8 collate utf8_unicode_ci NOT NULL,
  `rel_name` varchar(64) character set utf8 collate utf8_unicode_ci default NULL,
  `quantifier` smallint(5) unsigned DEFAULT '1',
