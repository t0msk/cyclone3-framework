...
CREATE TABLE `/*db_name*/`.`/*app*/_promo_item` (
  `ID` bigint(20) unsigned NOT NULL auto_increment,
  `ID_entity` bigint(20) unsigned default NULL,
  `ID_category` bigint(20) unsigned default NULL, -- rel promo_cat.ID
  `title` varchar(128) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `title_url` varchar(128) character set ascii NOT NULL default '',
  `subtitle` varchar(128) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  ...
  `status_nofollow` char(1) character set ascii NOT NULL default 'N',
...
CREATE TABLE `/*db_name*/`.`/*app*/_promo_item_j` (
...
CREATE TABLE `/*db_name*/`.`/*app*/_promo_item_metaindex` (
...
CREATE TABLE `/*db_name*/`.`/*app*/_promo_cat` (
  `ID` bigint(20) unsigned NOT NULL auto_increment,
  `ID_entity` bigint(20) unsigned default NULL,
...
CREATE TABLE `/*db_name*/`.`/*app*/_promo_cat_j` (
  `ID` bigint(20) unsigned NOT NULL,
  `ID_entity` bigint(20) unsigned default NULL,
  `ID_charindex` varchar(64) character set ascii collate ascii_bin default NULL,
  `name` varchar(128) character set utf8 collate utf8_unicode_ci NOT NULL default '',
