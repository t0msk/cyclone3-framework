...
CREATE TABLE `/*db_name*/`.`/*addon*/_offer` (
  ...
  `alias_addon` varchar(64) character set ascii NOT NULL default '',
...
CREATE TABLE `/*db_name*/`.`/*addon*/_offer_j` (
...
CREATE TABLE `/*db_name*/`.`/*addon*/_offer_lng` ( -- language versions of offer
  `ID` bigint(20) unsigned NOT NULL auto_increment,
  `ID_entity` bigint(20) unsigned default NULL, -- rel _offer.ID
...
CREATE TABLE `/*db_name*/`.`/*addon*/_offer_lng_j` (
  `ID` bigint(20) unsigned NOT NULL,
...
CREATE TABLE `/*db_name*/`.`/*addon*/_offer_rfi` ( -- request for information
  `ID` bigint(20) unsigned NOT NULL auto_increment,
  `ID_offer` mediumint(8) unsigned NOT NULL, -- ref _offer.ID
  `datetime_create` datetime NOT NULL,
  ...
  KEY `SEL_0` (`ID_offer`,`datetime_create`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------

CREATE TABLE `/*db_name*/`.`/*addon*/_offer_cat` (
  `ID` bigint(20) unsigned NOT NULL auto_increment,
  `ID_entity` bigint(20) unsigned default NULL,
...
CREATE TABLE `/*db_name*/`.`/*addon*/_offer_cat_j` (
  `ID` bigint(20) unsigned NOT NULL,
  `ID_entity` bigint(20) unsigned default NULL,
  `ID_charindex` varchar(64) character set ascii collate ascii_bin default NULL,
  `name` varchar(128) character set utf8 collate utf8_unicode_ci NOT NULL default '',
...
CREATE TABLE `/*db_name*/`.`/*addon*/_offer_rel_cat` (
  `ID_category` bigint(20) unsigned NOT NULL auto_increment, -- rel _offer_cat.ID_entity
  `ID_offer` bigint(20) unsigned NOT NULL, -- rel _offer.ID,
  PRIMARY KEY  (`ID_category`,`ID_offer`)
