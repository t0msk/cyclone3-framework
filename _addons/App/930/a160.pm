...
sub get_relation_iteminfo
{
	...
	$env{'r_db_name'}=$App::930::db_name unless $env{'r_db_name'};
	
	my $lng_in;
	
	if ($env{'lng'})
	{
		$lng_in="AND rfp_lng.lng='".$env{'lng'}."'";
	}
