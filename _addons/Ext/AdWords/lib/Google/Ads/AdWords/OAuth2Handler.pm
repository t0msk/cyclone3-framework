...
package Google::Ads::AdWords::OAuth2Handler;

use strict;
use version;
use base qw(Google::Ads::Common::OAuth2Handler);
...
A concrete implementation of L<Google::Ads::Common::OAuth2Handler> that
defines the scope required to access AdWords API servers using
OAuth2, see <https://developers.google.com/accounts/docs/OAuth2> for details
of the protocol.

Refer to the base object L<Google::Ads::Common::OAuth2Handler>
