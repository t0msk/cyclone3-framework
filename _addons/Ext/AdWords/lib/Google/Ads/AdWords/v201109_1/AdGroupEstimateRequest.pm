package Google::Ads::AdWords::v201109_1::AdGroupEstimateRequest;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'keywordEstimateRequests' => 'Google::Ads::AdWords::v201109_1::KeywordEstimateRequest',
...
Google::Ads::AdWords::v201109_1::AdGroupEstimateRequest

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupEstimateRequest from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::AdGroupEstimateRequest
   ...
   keywordEstimateRequests =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::KeywordEstimateRequest
