...
package Google::Ads::AdWords::v201109_1::DataService::getAdGroupBidLandscape;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::DataService::getAdGroupBidLandscape

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getAdGroupBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::DataService::getAdGroupBidLandscape->new($data);
