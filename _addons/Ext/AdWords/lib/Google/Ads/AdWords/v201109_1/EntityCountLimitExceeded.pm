package Google::Ads::AdWords::v201109_1::EntityCountLimitExceeded;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::EntityCountLimitExceeded

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
EntityCountLimitExceeded from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::EntityCountLimitExceeded
   reason => $some_value, # EntityCountLimitExceeded.Reason
   enclosingId =>  $some_value, # string
