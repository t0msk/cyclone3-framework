package Google::Ads::AdWords::v201109_1::AdParamPolicyError;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::AdParamPolicyError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdParamPolicyError from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
