package Google::Ads::AdWords::v201109_1::Alert;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'alertSeverity' => 'Google::Ads::AdWords::v201109_1::AlertSeverity',
        'alertType' => 'Google::Ads::AdWords::v201109_1::AlertType',
        'clientCustomerId' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'details' => 'Google::Ads::AdWords::v201109_1::Detail',
    },
    {
...
Google::Ads::AdWords::v201109_1::Alert

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Alert from the namespace https://adwords.google.com/api/adwords/mcm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::Alert
   ...
   details =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::Detail
 },
