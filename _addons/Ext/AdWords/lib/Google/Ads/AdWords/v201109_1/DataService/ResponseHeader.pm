...
package Google::Ads::AdWords::v201109_1::DataService::ResponseHeader;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::DataService::ResponseHeader
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::DataService::ResponseHeader->new($data);
