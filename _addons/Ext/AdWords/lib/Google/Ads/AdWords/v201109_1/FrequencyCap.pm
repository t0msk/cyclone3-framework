package Google::Ads::AdWords::v201109_1::FrequencyCap;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'timeUnit' => 'Google::Ads::AdWords::v201109_1::TimeUnit',
        'level' => 'Google::Ads::AdWords::v201109_1::Level',
    },
    {
...
Google::Ads::AdWords::v201109_1::FrequencyCap

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FrequencyCap from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::FrequencyCap
   ...
   timeUnit => $some_value, # TimeUnit
   level => $some_value, # Level
 },
