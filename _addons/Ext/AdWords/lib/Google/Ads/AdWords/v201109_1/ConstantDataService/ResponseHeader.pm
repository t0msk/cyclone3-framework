...
package Google::Ads::AdWords::v201109_1::ConstantDataService::ResponseHeader;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::ConstantDataService::ResponseHeader
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::ConstantDataService::ResponseHeader->new($data);
