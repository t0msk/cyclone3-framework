package Google::Ads::AdWords::v201109_1::CustomerSyncError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::CustomerSyncError::Reason',
...
Google::Ads::AdWords::v201109_1::CustomerSyncError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CustomerSyncError from the namespace https://adwords.google.com/api/adwords/ch/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::CustomerSyncError
   reason => $some_value, # CustomerSyncError.Reason
