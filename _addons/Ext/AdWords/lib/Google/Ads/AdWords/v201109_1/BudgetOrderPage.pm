package Google::Ads::AdWords::v201109_1::BudgetOrderPage;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'entries' => 'Google::Ads::AdWords::v201109_1::BudgetOrder',
    },
    {
...
Google::Ads::AdWords::v201109_1::BudgetOrderPage

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BudgetOrderPage from the namespace https://adwords.google.com/api/adwords/billing/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::BudgetOrderPage
   entries =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::BudgetOrder
 },
