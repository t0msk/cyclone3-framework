package Google::Ads::AdWords::v201109_1::RealTimeBiddingSetting;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::Setting);
# Variety: sequence
...
Google::Ads::AdWords::v201109_1::RealTimeBiddingSetting

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
RealTimeBiddingSetting from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
