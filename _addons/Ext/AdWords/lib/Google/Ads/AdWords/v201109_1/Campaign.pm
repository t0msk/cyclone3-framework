package Google::Ads::AdWords::v201109_1::Campaign;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'status' => 'Google::Ads::AdWords::v201109_1::CampaignStatus',
        'servingStatus' => 'Google::Ads::AdWords::v201109_1::ServingStatus',
        ...
        'biddingStrategy' => 'Google::Ads::AdWords::v201109_1::BiddingStrategy',
        'conversionOptimizerEligibility' => 'Google::Ads::AdWords::v201109_1::ConversionOptimizerEligibility',
        'campaignStats' => 'Google::Ads::AdWords::v201109_1::CampaignStats',
        'adServingOptimizationStatus' => 'Google::Ads::AdWords::v201109_1::AdServingOptimizationStatus',
        'frequencyCap' => 'Google::Ads::AdWords::v201109_1::FrequencyCap',
        'settings' => 'Google::Ads::AdWords::v201109_1::Setting',
        'networkSetting' => 'Google::Ads::AdWords::v201109_1::NetworkSetting',
    },
    {
...
Google::Ads::AdWords::v201109_1::Campaign

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Campaign from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::Campaign
   ...
   biddingStrategy =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::BiddingStrategy
   conversionOptimizerEligibility =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::ConversionOptimizerEligibility
   campaignStats =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::CampaignStats
   adServingOptimizationStatus => $some_value, # AdServingOptimizationStatus
   frequencyCap =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::FrequencyCap
   settings =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::Setting
   networkSetting =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::NetworkSetting
 },
