package Google::Ads::AdWords::v201109_1::ExperimentPage;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'entries' => 'Google::Ads::AdWords::v201109_1::Experiment',
    },
    {
...
Google::Ads::AdWords::v201109_1::ExperimentPage

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ExperimentPage from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::ExperimentPage
   entries =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::Experiment
 },
