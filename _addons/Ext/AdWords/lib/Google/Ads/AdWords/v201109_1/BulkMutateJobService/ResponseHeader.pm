...
package Google::Ads::AdWords::v201109_1::BulkMutateJobService::ResponseHeader;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::BulkMutateJobService::ResponseHeader
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::BulkMutateJobService::ResponseHeader->new($data);
