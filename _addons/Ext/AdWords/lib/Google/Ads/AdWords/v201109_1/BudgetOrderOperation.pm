package Google::Ads::AdWords::v201109_1::BudgetOrderOperation;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'operand' => 'Google::Ads::AdWords::v201109_1::BudgetOrder',
    },
    {
...
Google::Ads::AdWords::v201109_1::BudgetOrderOperation

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BudgetOrderOperation from the namespace https://adwords.google.com/api/adwords/billing/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::BudgetOrderOperation
   operand =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::BudgetOrder
 },
