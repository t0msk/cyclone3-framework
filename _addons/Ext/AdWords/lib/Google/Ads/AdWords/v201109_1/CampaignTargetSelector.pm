package Google::Ads::AdWords::v201109_1::CampaignTargetSelector;
use strict;
use warnings;
...
CampaignTargetSelector from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
