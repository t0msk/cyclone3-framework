package Google::Ads::AdWords::v201109_1::Criterion;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::Criterion

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Criterion from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::Criterion
   id =>  $some_value, # long
   type => $some_value, # Criterion.Type
   Criterion__Type =>  $some_value, # string
 },
