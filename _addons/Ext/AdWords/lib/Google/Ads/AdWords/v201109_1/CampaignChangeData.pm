package Google::Ads::AdWords::v201109_1::CampaignChangeData;
use strict;
use warnings;
...
sub get_xmlns { 'https://adwords.google.com/api/adwords/ch/v201109_1' };
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'campaignChangeStatus' => 'Google::Ads::AdWords::v201109_1::ChangeStatus',
        'changedAdGroups' => 'Google::Ads::AdWords::v201109_1::AdGroupChangeData',
...
Google::Ads::AdWords::v201109_1::CampaignChangeData

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignChangeData from the namespace https://adwords.google.com/api/adwords/ch/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::CampaignChangeData
   ...
   changedAdGroups =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::AdGroupChangeData
