...
package Google::Ads::AdWords::v201109_1::CampaignService::ResponseHeader;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::CampaignService::ResponseHeader
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::CampaignService::ResponseHeader->new($data);
