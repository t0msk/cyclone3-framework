package Google::Ads::AdWords::v201109_1::BulkMutateJobStats;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::JobStats);
# Variety: sequence
...
Google::Ads::AdWords::v201109_1::BulkMutateJobStats

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BulkMutateJobStats from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::BulkMutateJobStats
   numOperations =>  $some_value, # int
   numFailedOperations =>  $some_value, # int
   numUnprocessedOperations =>  $some_value, # int
 },
