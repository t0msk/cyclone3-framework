package Google::Ads::AdWords::v201109_1::AdGroupAdError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::AdGroupAdError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::AdGroupAdError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupAdError from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::AdGroupAdError
   reason => $some_value, # AdGroupAdError.Reason
 },
