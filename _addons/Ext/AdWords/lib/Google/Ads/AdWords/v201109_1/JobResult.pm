package Google::Ads::AdWords::v201109_1::JobResult;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'BulkMutateResult' => 'Google::Ads::AdWords::v201109_1::BulkMutateResult',
        'SimpleMutateResult' => 'Google::Ads::AdWords::v201109_1::SimpleMutateResult',
    },
    {
...
Google::Ads::AdWords::v201109_1::JobResult

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
JobResult from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::JobResult
   ...
   BulkMutateResult =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::BulkMutateResult
   SimpleMutateResult =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::SimpleMutateResult
 },
