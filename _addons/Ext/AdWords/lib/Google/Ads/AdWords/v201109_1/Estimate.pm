package Google::Ads::AdWords::v201109_1::Estimate;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::Estimate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Estimate from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::Estimate
   Estimate__Type =>  $some_value, # string
 },
