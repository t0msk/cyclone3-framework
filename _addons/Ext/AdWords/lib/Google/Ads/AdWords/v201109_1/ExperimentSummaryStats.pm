package Google::Ads::AdWords::v201109_1::ExperimentSummaryStats;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::ExperimentSummaryStats

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ExperimentSummaryStats from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::ExperimentSummaryStats
   adGroupsCount =>  $some_value, # int
   adGroupCriteriaCount =>  $some_value, # int
   adGroupAdsCount =>  $some_value, # int
 },
