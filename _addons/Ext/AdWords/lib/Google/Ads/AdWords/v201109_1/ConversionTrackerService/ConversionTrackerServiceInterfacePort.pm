package Google::Ads::AdWords::v201109_1::ConversionTrackerService::ConversionTrackerServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201109_1::TypeMaps::ConversionTrackerService
    if not Google::Ads::AdWords::v201109_1::TypeMaps::ConversionTrackerService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201109_1/ConversionTrackerService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201109_1::TypeMaps::ConversionTrackerService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201109_1::ConversionTrackerService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201109_1::ConversionTrackerService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201109_1::ConversionTrackerService::mutate )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/cm/v201109_1/ConversionTrackerService.
...
Returns a L<Google::Ads::AdWords::v201109_1::ConversionTrackerService::getResponse|Google::Ads::AdWords::v201109_1::ConversionTrackerService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201109_1::ConversionTrackerService::mutateResponse|Google::Ads::AdWords::v201109_1::ConversionTrackerService::mutateResponse> object.
