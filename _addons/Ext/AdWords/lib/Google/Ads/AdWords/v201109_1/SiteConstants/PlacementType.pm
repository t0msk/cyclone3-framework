package Google::Ads::AdWords::v201109_1::SiteConstants::PlacementType;
use strict;
use warnings;
...
SiteConstants.PlacementType from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
