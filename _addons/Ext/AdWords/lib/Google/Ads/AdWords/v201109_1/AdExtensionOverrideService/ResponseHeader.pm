...
package Google::Ads::AdWords::v201109_1::AdExtensionOverrideService::ResponseHeader;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::AdExtensionOverrideService::ResponseHeader
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::AdExtensionOverrideService::ResponseHeader->new($data);
