package Google::Ads::AdWords::v201109_1::TrafficEstimatorError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::TrafficEstimatorError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::TrafficEstimatorError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TrafficEstimatorError from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::TrafficEstimatorError
   reason => $some_value, # TrafficEstimatorError.Reason
 },
