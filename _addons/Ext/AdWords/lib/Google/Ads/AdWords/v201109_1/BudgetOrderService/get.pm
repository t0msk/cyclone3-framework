...
package Google::Ads::AdWords::v201109_1::BudgetOrderService::get;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::BudgetOrderService::get

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
get from the namespace https://adwords.google.com/api/adwords/billing/v201109_1.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::BudgetOrderService::get->new($data);
