package Google::Ads::AdWords::v201109_1::ReturnValueResult;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::OperationResult);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'returnValue' => 'Google::Ads::AdWords::v201109_1::Operand',
    },
    {
...
Google::Ads::AdWords::v201109_1::ReturnValueResult

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ReturnValueResult from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::ReturnValueResult
   returnValue =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::Operand
 },
