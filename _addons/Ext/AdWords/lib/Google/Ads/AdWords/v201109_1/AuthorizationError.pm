package Google::Ads::AdWords::v201109_1::AuthorizationError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::AuthorizationError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::AuthorizationError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AuthorizationError from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::AuthorizationError
   reason => $some_value, # AuthorizationError.Reason
 },
