...
package Google::Ads::AdWords::v201109_1::CampaignCriterionService::ResponseHeader;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::CampaignCriterionService::ResponseHeader
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::CampaignCriterionService::ResponseHeader->new($data);
