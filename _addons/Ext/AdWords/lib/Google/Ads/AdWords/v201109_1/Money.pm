package Google::Ads::AdWords::v201109_1::Money;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::ComparableValue);
# Variety: sequence
...
Google::Ads::AdWords::v201109_1::Money

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Money from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
