package Google::Ads::AdWords::v201109_1::MatchesRegexError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::MatchesRegexError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::MatchesRegexError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
MatchesRegexError from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::MatchesRegexError
   reason => $some_value, # MatchesRegexError.Reason
 },
