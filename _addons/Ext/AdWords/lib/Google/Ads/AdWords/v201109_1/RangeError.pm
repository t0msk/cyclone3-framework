package Google::Ads::AdWords::v201109_1::RangeError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::RangeError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::RangeError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
RangeError from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::RangeError
   reason => $some_value, # RangeError.Reason
 },
