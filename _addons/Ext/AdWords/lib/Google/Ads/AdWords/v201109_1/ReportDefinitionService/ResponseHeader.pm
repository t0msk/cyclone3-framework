...
package Google::Ads::AdWords::v201109_1::ReportDefinitionService::ResponseHeader;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::ReportDefinitionService::ResponseHeader
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::ReportDefinitionService::ResponseHeader->new($data);
