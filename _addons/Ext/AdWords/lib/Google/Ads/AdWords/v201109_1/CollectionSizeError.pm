package Google::Ads::AdWords::v201109_1::CollectionSizeError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::CollectionSizeError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::CollectionSizeError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CollectionSizeError from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::CollectionSizeError
   reason => $some_value, # CollectionSizeError.Reason
 },
