package Google::Ads::AdWords::v201109_1::BillingAccount;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::BillingAccount

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BillingAccount from the namespace https://adwords.google.com/api/adwords/billing/v201109_1.
