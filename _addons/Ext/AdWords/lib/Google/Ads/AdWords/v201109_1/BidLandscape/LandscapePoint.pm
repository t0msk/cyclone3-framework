package Google::Ads::AdWords::v201109_1::BidLandscape::LandscapePoint;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'bid' => 'Google::Ads::AdWords::v201109_1::Money',
        'clicks' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'cost' => 'Google::Ads::AdWords::v201109_1::Money',
        'marginalCpc' => 'Google::Ads::AdWords::v201109_1::Money',
...
Google::Ads::AdWords::v201109_1::BidLandscape::LandscapePoint

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BidLandscape.LandscapePoint from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::BidLandscape::LandscapePoint
   bid =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::Money
   clicks =>  $some_value, # long
   cost =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::Money
   marginalCpc =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::Money
