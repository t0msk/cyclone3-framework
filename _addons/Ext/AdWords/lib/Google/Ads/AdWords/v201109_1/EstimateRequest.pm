package Google::Ads::AdWords::v201109_1::EstimateRequest;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::EstimateRequest

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
EstimateRequest from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::EstimateRequest
   EstimateRequest__Type =>  $some_value, # string
 },
