package Google::Ads::AdWords::v201109_1::Setting;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::Setting

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Setting from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::Setting
   Setting__Type =>  $some_value, # string
 },
