package Google::Ads::AdWords::v201109_1::LocationSyncExtension;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'oAuthInfo' => 'Google::Ads::AdWords::v201109_1::OAuthInfo',
...
Google::Ads::AdWords::v201109_1::LocationSyncExtension

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
LocationSyncExtension from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::LocationSyncExtension
   ...
   oAuthInfo =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::OAuthInfo
