package Google::Ads::AdWords::v201109_1::AdGroupCriterionBids;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::AdGroupCriterionBids

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupCriterionBids from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
=item * AdGroupCriterionBids__Type
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::AdGroupCriterionBids
   AdGroupCriterionBids__Type =>  $some_value, # string
 },
