package Google::Ads::AdWords::v201109_1::CampaignOperation;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'biddingTransition' => 'Google::Ads::AdWords::v201109_1::BiddingTransition',
        'operand' => 'Google::Ads::AdWords::v201109_1::Campaign',
    },
    {
...
Google::Ads::AdWords::v201109_1::CampaignOperation

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignOperation from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::CampaignOperation
   biddingTransition =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::BiddingTransition
   operand =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::Campaign
 },
