package Google::Ads::AdWords::v201109_1::AdWordsConversionTracker;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::ConversionTracker);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'status' => 'Google::Ads::AdWords::v201109_1::ConversionTracker::Status',
        'category' => 'Google::Ads::AdWords::v201109_1::ConversionTracker::Category',
        'stats' => 'Google::Ads::AdWords::v201109_1::ConversionTrackerStats',
        ...
        'markupLanguage' => 'Google::Ads::AdWords::v201109_1::AdWordsConversionTracker::MarkupLanguage',
        'httpProtocol' => 'Google::Ads::AdWords::v201109_1::AdWordsConversionTracker::HttpProtocol',
        'textFormat' => 'Google::Ads::AdWords::v201109_1::AdWordsConversionTracker::TextFormat',
...
Google::Ads::AdWords::v201109_1::AdWordsConversionTracker

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdWordsConversionTracker from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
