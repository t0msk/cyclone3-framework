...
package Google::Ads::AdWords::v201109_1::TargetingIdeaService::getBulkKeywordIdeas;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'selector' => 'Google::Ads::AdWords::v201109_1::TargetingIdeaSelector',
    },
    {
...
Google::Ads::AdWords::v201109_1::TargetingIdeaService::getBulkKeywordIdeas

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getBulkKeywordIdeas from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::TargetingIdeaService::getBulkKeywordIdeas->new($data);
