package Google::Ads::AdWords::v201109_1::QuotaError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::QuotaError::Reason',
...
Google::Ads::AdWords::v201109_1::QuotaError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
QuotaError from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
