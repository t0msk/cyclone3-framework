package Google::Ads::AdWords::v201109_1::CriterionError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::CriterionError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::CriterionError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CriterionError from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::CriterionError
   reason => $some_value, # CriterionError.Reason
 },
