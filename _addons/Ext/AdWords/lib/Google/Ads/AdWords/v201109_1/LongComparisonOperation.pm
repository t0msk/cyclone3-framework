package Google::Ads::AdWords::v201109_1::LongComparisonOperation;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::LongComparisonOperation

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
LongComparisonOperation from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::LongComparisonOperation
   minimum =>  $some_value, # long
   maximum =>  $some_value, # long
 },
