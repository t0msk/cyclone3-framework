package Google::Ads::AdWords::v201109_1::BiddableAdGroupCriterion;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::AdGroupCriterion);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'criterionUse' => 'Google::Ads::AdWords::v201109_1::CriterionUse',
        'criterion' => 'Google::Ads::AdWords::v201109_1::Criterion',
        'AdGroupCriterion__Type' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'userStatus' => 'Google::Ads::AdWords::v201109_1::UserStatus',
        'systemServingStatus' => 'Google::Ads::AdWords::v201109_1::SystemServingStatus',
        'approvalStatus' => 'Google::Ads::AdWords::v201109_1::ApprovalStatus',
        'destinationUrl' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'bids' => 'Google::Ads::AdWords::v201109_1::AdGroupCriterionBids',
        'experimentData' => 'Google::Ads::AdWords::v201109_1::BiddableAdGroupCriterionExperimentData',
        'firstPageCpc' => 'Google::Ads::AdWords::v201109_1::Bid',
        'topOfPageCpc' => 'Google::Ads::AdWords::v201109_1::Bid',
        'qualityInfo' => 'Google::Ads::AdWords::v201109_1::QualityInfo',
...
Google::Ads::AdWords::v201109_1::BiddableAdGroupCriterion

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BiddableAdGroupCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::BiddableAdGroupCriterion
   ...
   bids =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::AdGroupCriterionBids
   experimentData =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::BiddableAdGroupCriterionExperimentData
   firstPageCpc =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::Bid
   topOfPageCpc =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::Bid
   qualityInfo =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::QualityInfo
