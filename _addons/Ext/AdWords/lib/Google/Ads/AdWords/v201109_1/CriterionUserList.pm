package Google::Ads::AdWords::v201109_1::CriterionUserList;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'userListMembershipStatus' => 'Google::Ads::AdWords::v201109_1::CriterionUserList::MembershipStatus',
    },
    {
...
Google::Ads::AdWords::v201109_1::CriterionUserList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CriterionUserList from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
