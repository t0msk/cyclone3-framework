package Google::Ads::AdWords::v201109_1::ApiUsageInfo;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'apiUsageRecords' => 'Google::Ads::AdWords::v201109_1::ApiUsageRecord',
...
Google::Ads::AdWords::v201109_1::ApiUsageInfo

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ApiUsageInfo from the namespace https://adwords.google.com/api/adwords/info/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::ApiUsageInfo
   apiUsageRecords =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::ApiUsageRecord
