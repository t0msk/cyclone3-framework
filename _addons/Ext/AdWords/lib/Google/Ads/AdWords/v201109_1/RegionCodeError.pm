package Google::Ads::AdWords::v201109_1::RegionCodeError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::RegionCodeError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::RegionCodeError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
RegionCodeError from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::RegionCodeError
   reason => $some_value, # RegionCodeError.Reason
 },
