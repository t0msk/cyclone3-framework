package Google::Ads::AdWords::v201109_1::ManagedCustomer;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::ManagedCustomer

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ManagedCustomer from the namespace https://adwords.google.com/api/adwords/mcm/v201109_1.
