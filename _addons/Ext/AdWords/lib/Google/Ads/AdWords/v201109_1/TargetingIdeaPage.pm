package Google::Ads::AdWords::v201109_1::TargetingIdeaPage;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'entries' => 'Google::Ads::AdWords::v201109_1::TargetingIdea',
    },
    {
...
Google::Ads::AdWords::v201109_1::TargetingIdeaPage

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TargetingIdeaPage from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::TargetingIdeaPage
   ...
   entries =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::TargetingIdea
 },
