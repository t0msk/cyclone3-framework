package Google::Ads::AdWords::v201109_1::DoubleValue;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::NumberValue);
# Variety: sequence
...
Google::Ads::AdWords::v201109_1::DoubleValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DoubleValue from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
