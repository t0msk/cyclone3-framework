package Google::Ads::AdWords::v201109_1::Keyword;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'matchType' => 'Google::Ads::AdWords::v201109_1::KeywordMatchType',
    },
    {
...
Google::Ads::AdWords::v201109_1::Keyword

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Keyword from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::Keyword
   ...
   matchType => $some_value, # KeywordMatchType
 },
