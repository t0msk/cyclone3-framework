package Google::Ads::AdWords::v201109_1::NegativeAdGroupCriterion;
use strict;
use warnings;
...
NegativeAdGroupCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
