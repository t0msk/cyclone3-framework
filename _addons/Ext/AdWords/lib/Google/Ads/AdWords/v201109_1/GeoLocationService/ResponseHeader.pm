...
package Google::Ads::AdWords::v201109_1::GeoLocationService::ResponseHeader;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::GeoLocationService::ResponseHeader
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::GeoLocationService::ResponseHeader->new($data);
