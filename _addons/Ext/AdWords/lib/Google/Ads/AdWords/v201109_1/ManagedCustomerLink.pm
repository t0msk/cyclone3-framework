package Google::Ads::AdWords::v201109_1::ManagedCustomerLink;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::ManagedCustomerLink

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ManagedCustomerLink from the namespace https://adwords.google.com/api/adwords/mcm/v201109_1.
