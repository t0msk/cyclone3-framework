package Google::Ads::AdWords::v201109_1::ProductExtension;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'productSelection' => 'Google::Ads::AdWords::v201109_1::ProductConditionAndGroup',
    },
    {
...
Google::Ads::AdWords::v201109_1::ProductExtension

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ProductExtension from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::ProductExtension
   googleBaseCustomerId =>  $some_value, # int
   advertiserName =>  $some_value, # string
   productSelection =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::ProductConditionAndGroup
 },
