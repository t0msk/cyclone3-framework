package Google::Ads::AdWords::v201109_1::EntityId;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'type' => 'Google::Ads::AdWords::v201109_1::EntityId::Type',
...
Google::Ads::AdWords::v201109_1::EntityId

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
EntityId from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
