package Google::Ads::AdWords::v201109_1::BiddableAdGroupCriterionExperimentData;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'experimentBidMultiplier' => 'Google::Ads::AdWords::v201109_1::AdGroupCriterionExperimentBidMultiplier',
    },
    {
...
BiddableAdGroupCriterionExperimentData from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::BiddableAdGroupCriterionExperimentData
   ...
   experimentBidMultiplier =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::AdGroupCriterionExperimentBidMultiplier
 },
