package Google::Ads::AdWords::v201109_1::PolicyViolationError;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::ApiError);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'key' => 'Google::Ads::AdWords::v201109_1::PolicyViolationKey',
        ...
        'violatingParts' => 'Google::Ads::AdWords::v201109_1::PolicyViolationError::Part',
    },
    {
...
Google::Ads::AdWords::v201109_1::PolicyViolationError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PolicyViolationError from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::PolicyViolationError
   key =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::PolicyViolationKey
   ...
   violatingParts =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::PolicyViolationError::Part
 },
