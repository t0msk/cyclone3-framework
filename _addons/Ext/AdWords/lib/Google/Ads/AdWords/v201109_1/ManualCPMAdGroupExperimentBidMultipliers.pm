package Google::Ads::AdWords::v201109_1::ManualCPMAdGroupExperimentBidMultipliers;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'maxCpmMultiplier' => 'Google::Ads::AdWords::v201109_1::BidMultiplier',
    },
    {
...
Google::Ads::AdWords::v201109_1::ManualCPMAdGroupExperimentBidMultipliers

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ManualCPMAdGroupExperimentBidMultipliers from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::ManualCPMAdGroupExperimentBidMultipliers
   maxCpmMultiplier =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::BidMultiplier
 },
