package Google::Ads::AdWords::v201109_1::AdGroupBidLandscape;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::BidLandscape);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'landscapePoints' => 'Google::Ads::AdWords::v201109_1::BidLandscape::LandscapePoint',
        'type' => 'Google::Ads::AdWords::v201109_1::AdGroupBidLandscape::Type',
...
Google::Ads::AdWords::v201109_1::AdGroupBidLandscape

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::AdGroupBidLandscape
   type => $some_value, # AdGroupBidLandscape.Type
   landscapeCurrent =>  $some_value, # boolean
 },
