package Google::Ads::AdWords::v201109_1::TempAdUnionId;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::AdUnionId);
# Variety: sequence
...
Google::Ads::AdWords::v201109_1::TempAdUnionId

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TempAdUnionId from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
