package Google::Ads::AdWords::v201109_1::DataError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::DataError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::DataError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DataError from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::DataError
   reason => $some_value, # DataError.Reason
 },
