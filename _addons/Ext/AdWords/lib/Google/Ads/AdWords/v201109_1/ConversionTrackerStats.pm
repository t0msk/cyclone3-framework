package Google::Ads::AdWords::v201109_1::ConversionTrackerStats;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'conversionValue' => 'Google::Ads::AdWords::v201109_1::Money',
...
Google::Ads::AdWords::v201109_1::ConversionTrackerStats

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ConversionTrackerStats from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::ConversionTrackerStats
   ...
   conversionValue =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::Money
