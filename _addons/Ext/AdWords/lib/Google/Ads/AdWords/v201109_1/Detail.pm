package Google::Ads::AdWords::v201109_1::Detail;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::Detail

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Detail from the namespace https://adwords.google.com/api/adwords/mcm/v201109_1.
