package Google::Ads::AdWords::v201109_1::ApiError;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::ApiError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ApiError from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::ApiError
   fieldPath =>  $some_value, # string
   trigger =>  $some_value, # string
   errorString =>  $some_value, # string
   ApiError__Type =>  $some_value, # string
 },
