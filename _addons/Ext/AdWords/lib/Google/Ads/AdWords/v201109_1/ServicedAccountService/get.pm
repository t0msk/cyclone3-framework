...
package Google::Ads::AdWords::v201109_1::ServicedAccountService::get;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'selector' => 'Google::Ads::AdWords::v201109_1::ServicedAccountSelector',
    },
    {
...
Google::Ads::AdWords::v201109_1::ServicedAccountService::get

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
get from the namespace https://adwords.google.com/api/adwords/mcm/v201109_1.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::ServicedAccountService::get->new($data);

Constructor. The following data structure may be passed to new():

 {
   selector =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::ServicedAccountSelector
 },
