package Google::Ads::AdWords::v201109_1::AdGroupBidLandscapePage;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'entries' => 'Google::Ads::AdWords::v201109_1::AdGroupBidLandscape',
    },
    {
...
Google::Ads::AdWords::v201109_1::AdGroupBidLandscapePage

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupBidLandscapePage from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::AdGroupBidLandscapePage
   entries =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::AdGroupBidLandscape
 },
