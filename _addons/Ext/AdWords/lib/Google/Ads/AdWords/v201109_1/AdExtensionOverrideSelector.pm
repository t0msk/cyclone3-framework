package Google::Ads::AdWords::v201109_1::AdExtensionOverrideSelector;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'statuses' => 'Google::Ads::AdWords::v201109_1::AdExtensionOverride::Status',
...
Google::Ads::AdWords::v201109_1::AdExtensionOverrideSelector

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdExtensionOverrideSelector from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::AdExtensionOverrideSelector
   ...
   adIds =>  $some_value, # long
   adExtensionIds =>  $some_value, # long
   statuses => $some_value, # AdExtensionOverride.Status
