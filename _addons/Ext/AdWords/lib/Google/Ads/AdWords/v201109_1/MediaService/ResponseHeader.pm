...
package Google::Ads::AdWords::v201109_1::MediaService::ResponseHeader;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::MediaService::ResponseHeader
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::MediaService::ResponseHeader->new($data);
