package Google::Ads::AdWords::v201109_1::CampaignAdExtensionOperation;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'operand' => 'Google::Ads::AdWords::v201109_1::CampaignAdExtension',
    },
    {
...
Google::Ads::AdWords::v201109_1::CampaignAdExtensionOperation

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignAdExtensionOperation from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::CampaignAdExtensionOperation
   operand =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::CampaignAdExtension
 },
