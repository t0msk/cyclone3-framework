package Google::Ads::AdWords::v201109_1::BudgetOptimizer;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'bidCeiling' => 'Google::Ads::AdWords::v201109_1::Money',
    },
    {
...
Google::Ads::AdWords::v201109_1::BudgetOptimizer

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BudgetOptimizer from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::BudgetOptimizer
   ...
   bidCeiling =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::Money
 },
