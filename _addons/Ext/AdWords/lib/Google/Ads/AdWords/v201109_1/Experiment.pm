package Google::Ads::AdWords::v201109_1::Experiment;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'status' => 'Google::Ads::AdWords::v201109_1::ExperimentStatus',
        'servingStatus' => 'Google::Ads::AdWords::v201109_1::ExperimentServingStatus',
        ...
        'experimentSummaryStats' => 'Google::Ads::AdWords::v201109_1::ExperimentSummaryStats',
    },
    {
...
Google::Ads::AdWords::v201109_1::Experiment

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Experiment from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::Experiment
   id =>  $some_value, # long
   controlId =>  $some_value, # long
   campaignId =>  $some_value, # long
   name =>  $some_value, # string
   status => $some_value, # ExperimentStatus
   servingStatus => $some_value, # ExperimentServingStatus
   queryPercentage =>  $some_value, # int
   startDateTime =>  $some_value, # string
   endDateTime =>  $some_value, # string
   lastModifiedDateTime =>  $some_value, # string
   experimentSummaryStats =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::ExperimentSummaryStats
 },
