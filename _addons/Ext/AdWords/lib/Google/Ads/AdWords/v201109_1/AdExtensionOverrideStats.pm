package Google::Ads::AdWords::v201109_1::AdExtensionOverrideStats;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::AdExtensionOverrideStats

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdExtensionOverrideStats from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
