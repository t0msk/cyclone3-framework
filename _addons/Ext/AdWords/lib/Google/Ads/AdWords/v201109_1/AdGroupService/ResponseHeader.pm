...
package Google::Ads::AdWords::v201109_1::AdGroupService::ResponseHeader;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::AdGroupService::ResponseHeader
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::AdGroupService::ResponseHeader->new($data);
