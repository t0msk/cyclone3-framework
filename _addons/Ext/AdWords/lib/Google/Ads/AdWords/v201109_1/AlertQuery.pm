package Google::Ads::AdWords::v201109_1::AlertQuery;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'clientSpec' => 'Google::Ads::AdWords::v201109_1::ClientSpec',
        'filterSpec' => 'Google::Ads::AdWords::v201109_1::FilterSpec',
        'types' => 'Google::Ads::AdWords::v201109_1::AlertType',
        'severities' => 'Google::Ads::AdWords::v201109_1::AlertSeverity',
        'triggerTimeSpec' => 'Google::Ads::AdWords::v201109_1::TriggerTimeSpec',
...
Google::Ads::AdWords::v201109_1::AlertQuery

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AlertQuery from the namespace https://adwords.google.com/api/adwords/mcm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::AlertQuery
   clientSpec => $some_value, # ClientSpec
   filterSpec => $some_value, # FilterSpec
   types => $some_value, # AlertType
   severities => $some_value, # AlertSeverity
   triggerTimeSpec => $some_value, # TriggerTimeSpec
