package Google::Ads::AdWords::v201109_1::InStreamAdInfo;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::InStreamAdInfo

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
InStreamAdInfo from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::InStreamAdInfo
   maxAdDuration =>  $some_value, # int
   minAdDuration =>  $some_value, # int
   medianAdDuration =>  $some_value, # int
   preRollPercent =>  $some_value, # double
   midRollPercent =>  $some_value, # double
   postRollPercent =>  $some_value, # double
 },
