...
package Google::Ads::AdWords::v201109_1::UserListService::ResponseHeader;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::UserListService::ResponseHeader
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::UserListService::ResponseHeader->new($data);
