package Google::Ads::AdWords::v201109_1::CompetitionSearchParameter;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'levels' => 'Google::Ads::AdWords::v201109_1::CompetitionSearchParameter::Level',
    },
    {
...
Google::Ads::AdWords::v201109_1::CompetitionSearchParameter

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CompetitionSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::CompetitionSearchParameter
   levels => $some_value, # CompetitionSearchParameter.Level
 },
