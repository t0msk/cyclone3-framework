package Google::Ads::AdWords::v201109_1::InternalApiError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::InternalApiError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::InternalApiError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
InternalApiError from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::InternalApiError
   reason => $some_value, # InternalApiError.Reason
 },
