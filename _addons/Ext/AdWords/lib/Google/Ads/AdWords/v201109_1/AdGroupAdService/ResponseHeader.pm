...
package Google::Ads::AdWords::v201109_1::AdGroupAdService::ResponseHeader;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::AdGroupAdService::ResponseHeader
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::AdGroupAdService::ResponseHeader->new($data);
