package Google::Ads::AdWords::v201109_1::BudgetError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::BudgetError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::BudgetError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BudgetError from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::BudgetError
   reason => $some_value, # BudgetError.Reason
 },
