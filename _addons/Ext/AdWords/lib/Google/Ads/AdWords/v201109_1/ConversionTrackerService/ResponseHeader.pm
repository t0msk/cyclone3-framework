...
package Google::Ads::AdWords::v201109_1::ConversionTrackerService::ResponseHeader;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::ConversionTrackerService::ResponseHeader
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::ConversionTrackerService::ResponseHeader->new($data);
