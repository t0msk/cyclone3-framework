package Google::Ads::AdWords::v201109_1::AlertError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::AlertError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::AlertError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AlertError from the namespace https://adwords.google.com/api/adwords/mcm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::AlertError
   reason => $some_value, # AlertError.Reason
 },
