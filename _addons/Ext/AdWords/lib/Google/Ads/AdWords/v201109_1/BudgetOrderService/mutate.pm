...
package Google::Ads::AdWords::v201109_1::BudgetOrderService::mutate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201109_1::BudgetOrderOperation',
    },
    {
...
Google::Ads::AdWords::v201109_1::BudgetOrderService::mutate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutate from the namespace https://adwords.google.com/api/adwords/billing/v201109_1.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::BudgetOrderService::mutate->new($data);
