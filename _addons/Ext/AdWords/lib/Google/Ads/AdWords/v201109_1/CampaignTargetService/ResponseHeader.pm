...
package Google::Ads::AdWords::v201109_1::CampaignTargetService::ResponseHeader;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::CampaignTargetService::ResponseHeader
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::CampaignTargetService::ResponseHeader->new($data);
