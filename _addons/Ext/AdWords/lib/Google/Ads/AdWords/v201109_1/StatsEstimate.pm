package Google::Ads::AdWords::v201109_1::StatsEstimate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'totalCost' => 'Google::Ads::AdWords::v201109_1::Money',
    },
    {
...
Google::Ads::AdWords::v201109_1::StatsEstimate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
StatsEstimate from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::StatsEstimate
   ...
   totalCost =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::Money
 },
