package Google::Ads::AdWords::v201109_1::ServicedAccountError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::ServicedAccountError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::ServicedAccountError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ServicedAccountError from the namespace https://adwords.google.com/api/adwords/mcm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::ServicedAccountError
   reason => $some_value, # ServicedAccountError.Reason
 },
