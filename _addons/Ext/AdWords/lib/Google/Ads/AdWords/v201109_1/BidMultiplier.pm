package Google::Ads::AdWords::v201109_1::BidMultiplier;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'multipliedBid' => 'Google::Ads::AdWords::v201109_1::Bid',
    },
    {
...
Google::Ads::AdWords::v201109_1::BidMultiplier

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BidMultiplier from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::BidMultiplier
   ...
   multipliedBid =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::Bid
 },
