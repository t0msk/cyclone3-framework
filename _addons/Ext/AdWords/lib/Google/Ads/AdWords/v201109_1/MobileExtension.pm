package Google::Ads::AdWords::v201109_1::MobileExtension;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::MobileExtension

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
MobileExtension from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
