package Google::Ads::AdWords::v201109_1::BetaError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::BetaError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::BetaError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BetaError from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::BetaError
   reason => $some_value, # BetaError.Reason
 },
