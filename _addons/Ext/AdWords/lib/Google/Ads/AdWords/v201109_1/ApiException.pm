package Google::Ads::AdWords::v201109_1::ApiException;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::ApplicationException);
# Variety: sequence
...
ApiException from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
