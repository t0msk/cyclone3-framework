package Google::Ads::AdWords::v201109_1::MonthlySearchVolumeAttribute;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::Attribute);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'value' => 'Google::Ads::AdWords::v201109_1::MonthlySearchVolume',
    },
    {
...
Google::Ads::AdWords::v201109_1::MonthlySearchVolumeAttribute

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
MonthlySearchVolumeAttribute from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::MonthlySearchVolumeAttribute
   value =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::MonthlySearchVolume
 },
