package Google::Ads::AdWords::v201109_1::IdError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::IdError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::IdError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
IdError from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::IdError
   reason => $some_value, # IdError.Reason
 },
