package Google::Ads::AdWords::v201109_1::Platform;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::Platform

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Platform from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.

Represents Platform criterion. <p>A criterion of this type can only be created using an ID. A criterion of this type is only targetable. 
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::Platform
   platformName =>  $some_value, # string
 },
