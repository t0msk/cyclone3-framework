package Google::Ads::AdWords::v201109_1::CreateAccountError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::CreateAccountError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::CreateAccountError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CreateAccountError from the namespace https://adwords.google.com/api/adwords/mcm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::CreateAccountError
   reason => $some_value, # CreateAccountError.Reason
 },
