package Google::Ads::AdWords::v201109_1::ManualCPCAdGroupCriterionExperimentBidMultiplier;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::AdGroupCriterionExperimentBidMultiplier);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'multiplierSource' => 'Google::Ads::AdWords::v201109_1::MultiplierSource',
    },
    {
...
Google::Ads::AdWords::v201109_1::ManualCPCAdGroupCriterionExperimentBidMultiplier

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ManualCPCAdGroupCriterionExperimentBidMultiplier from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::ManualCPCAdGroupCriterionExperimentBidMultiplier
   ...
   multiplierSource => $some_value, # MultiplierSource
 },
