package Google::Ads::AdWords::v201109_1::RelatedToUrlSearchParameter;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::RelatedToUrlSearchParameter

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
RelatedToUrlSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::RelatedToUrlSearchParameter
   urls =>  $some_value, # string
   includeSubUrls =>  $some_value, # boolean
 },
