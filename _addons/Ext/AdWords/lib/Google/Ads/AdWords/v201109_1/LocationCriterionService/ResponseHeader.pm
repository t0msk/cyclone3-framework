...
package Google::Ads::AdWords::v201109_1::LocationCriterionService::ResponseHeader;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::LocationCriterionService::ResponseHeader
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::LocationCriterionService::ResponseHeader->new($data);
