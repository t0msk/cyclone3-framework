package Google::Ads::AdWords::v201109_1::GeoLocationError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::GeoLocationError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::GeoLocationError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
GeoLocationError from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::GeoLocationError
   reason => $some_value, # GeoLocationError.Reason
 },
