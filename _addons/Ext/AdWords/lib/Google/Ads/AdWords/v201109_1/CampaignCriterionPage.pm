package Google::Ads::AdWords::v201109_1::CampaignCriterionPage;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'entries' => 'Google::Ads::AdWords::v201109_1::CampaignCriterion',
    },
    {
...
Google::Ads::AdWords::v201109_1::CampaignCriterionPage

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignCriterionPage from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::CampaignCriterionPage
   entries =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::CampaignCriterion
 },
