...
package Google::Ads::AdWords::v201109_1::AdGroupCriterionService::ResponseHeader;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::AdGroupCriterionService::ResponseHeader
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::AdGroupCriterionService::ResponseHeader->new($data);
