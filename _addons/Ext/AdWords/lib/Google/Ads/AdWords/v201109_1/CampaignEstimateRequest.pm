package Google::Ads::AdWords::v201109_1::CampaignEstimateRequest;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'adGroupEstimateRequests' => 'Google::Ads::AdWords::v201109_1::AdGroupEstimateRequest',
        'criteria' => 'Google::Ads::AdWords::v201109_1::Criterion',
        'networkSetting' => 'Google::Ads::AdWords::v201109_1::NetworkSetting',
        'dailyBudget' => 'Google::Ads::AdWords::v201109_1::Money',
    },
    {
...
Google::Ads::AdWords::v201109_1::CampaignEstimateRequest

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignEstimateRequest from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::CampaignEstimateRequest
   ...
   adGroupEstimateRequests =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::AdGroupEstimateRequest
   criteria =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::Criterion
   networkSetting =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::NetworkSetting
   dailyBudget =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::Money
 },
