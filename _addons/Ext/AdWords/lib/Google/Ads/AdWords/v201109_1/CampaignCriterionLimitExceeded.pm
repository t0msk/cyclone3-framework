package Google::Ads::AdWords::v201109_1::CampaignCriterionLimitExceeded;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::EntityCountLimitExceeded);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::EntityCountLimitExceeded::Reason',
        'enclosingId' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'limit' => 'SOAP::WSDL::XSD::Typelib::Builtin::int',
        'limitType' => 'Google::Ads::AdWords::v201109_1::CampaignCriterionLimitExceeded::CriteriaLimitType',
    },
    {
...
Google::Ads::AdWords::v201109_1::CampaignCriterionLimitExceeded

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignCriterionLimitExceeded from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::CampaignCriterionLimitExceeded
   limitType => $some_value, # CampaignCriterionLimitExceeded.CriteriaLimitType
 },
