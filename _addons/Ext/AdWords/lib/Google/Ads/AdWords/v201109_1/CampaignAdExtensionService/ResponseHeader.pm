...
package Google::Ads::AdWords::v201109_1::CampaignAdExtensionService::ResponseHeader;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::CampaignAdExtensionService::ResponseHeader
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::CampaignAdExtensionService::ResponseHeader->new($data);
