package Google::Ads::AdWords::v201109_1::BulkMutateJob;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::Job);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'policy' => 'Google::Ads::AdWords::v201109_1::BulkMutateJobPolicy',
        'request' => 'Google::Ads::AdWords::v201109_1::BulkMutateRequest',
        'status' => 'Google::Ads::AdWords::v201109_1::BasicJobStatus',
        'history' => 'Google::Ads::AdWords::v201109_1::BulkMutateJobEvent',
        'result' => 'Google::Ads::AdWords::v201109_1::BulkMutateResult',
...
BulkMutateJob from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
