package Google::Ads::AdWords::v201109_1::IntegerSetAttribute;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::IntegerSetAttribute

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
IntegerSetAttribute from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
