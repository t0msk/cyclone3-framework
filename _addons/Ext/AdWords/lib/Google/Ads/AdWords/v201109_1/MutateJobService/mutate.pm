...
package Google::Ads::AdWords::v201109_1::MutateJobService::mutate;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::MutateJobService::mutate
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::MutateJobService::mutate->new($data);
