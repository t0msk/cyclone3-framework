package Google::Ads::AdWords::v201109_1::CriterionPolicyError;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::PolicyViolationError);
# Variety: sequence
...
Google::Ads::AdWords::v201109_1::CriterionPolicyError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CriterionPolicyError from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
