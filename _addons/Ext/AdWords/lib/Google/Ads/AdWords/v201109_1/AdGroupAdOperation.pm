package Google::Ads::AdWords::v201109_1::AdGroupAdOperation;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'operand' => 'Google::Ads::AdWords::v201109_1::AdGroupAd',
...
Google::Ads::AdWords::v201109_1::AdGroupAdOperation

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupAdOperation from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::AdGroupAdOperation
   operand =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::AdGroupAd
