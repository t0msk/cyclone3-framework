package Google::Ads::AdWords::v201109_1::TargetingIdeaError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::TargetingIdeaError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::TargetingIdeaError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TargetingIdeaError from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::TargetingIdeaError
   reason => $some_value, # TargetingIdeaError.Reason
 },
