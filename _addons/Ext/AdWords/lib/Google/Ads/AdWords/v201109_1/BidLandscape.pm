package Google::Ads::AdWords::v201109_1::BidLandscape;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::DataEntry);
# Variety: sequence
...
Google::Ads::AdWords::v201109_1::BidLandscape

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::BidLandscape
   ...
   landscapePoints =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::BidLandscape::LandscapePoint
 },
