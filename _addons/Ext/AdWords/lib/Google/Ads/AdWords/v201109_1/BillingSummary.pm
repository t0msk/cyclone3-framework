package Google::Ads::AdWords::v201109_1::BillingSummary;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::BillingSummary

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BillingSummary from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
