package Google::Ads::AdWords::v201109_1::ConversionTrackerPage;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'entries' => 'Google::Ads::AdWords::v201109_1::ConversionTracker',
    },
    {
...
Google::Ads::AdWords::v201109_1::ConversionTrackerPage

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ConversionTrackerPage from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::ConversionTrackerPage
   entries =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::ConversionTracker
 },
