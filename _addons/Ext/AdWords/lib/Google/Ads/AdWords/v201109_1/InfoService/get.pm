...
package Google::Ads::AdWords::v201109_1::InfoService::get;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'selector' => 'Google::Ads::AdWords::v201109_1::InfoSelector',
    },
    {
...
Google::Ads::AdWords::v201109_1::InfoService::get

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
get from the namespace https://adwords.google.com/api/adwords/info/v201109_1.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::InfoService::get->new($data);
