package Google::Ads::AdWords::v201109_1::LogicalUserList;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'rules' => 'Google::Ads::AdWords::v201109_1::UserListLogicalRule',
    },
    {
...
Google::Ads::AdWords::v201109_1::LogicalUserList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
LogicalUserList from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::LogicalUserList
   rules =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::UserListLogicalRule
 },
