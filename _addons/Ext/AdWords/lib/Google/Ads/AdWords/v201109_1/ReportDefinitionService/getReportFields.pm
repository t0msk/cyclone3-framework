...
package Google::Ads::AdWords::v201109_1::ReportDefinitionService::getReportFields;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'reportType' => 'Google::Ads::AdWords::v201109_1::ReportDefinition::ReportType',
    },
    {
...
Google::Ads::AdWords::v201109_1::ReportDefinitionService::getReportFields

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getReportFields from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::ReportDefinitionService::getReportFields->new($data);
