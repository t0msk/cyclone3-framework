package Google::Ads::AdWords::v201109_1::Gender;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'genderType' => 'Google::Ads::AdWords::v201109_1::Gender::GenderType',
    },
    {
...
Google::Ads::AdWords::v201109_1::Gender

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Gender from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.

Represents a Gender criterion. <p>A criterion of this type can only be created using an ID. A criterion of this type is only excludable. 
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::Gender
   genderType => $some_value, # Gender.GenderType
 },
