package Google::Ads::AdWords::v201109_1::RemarketingUserList;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'conversionTypes' => 'Google::Ads::AdWords::v201109_1::UserListConversionType',
    },
    {
...
Google::Ads::AdWords::v201109_1::RemarketingUserList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
RemarketingUserList from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::RemarketingUserList
   conversionTypes =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::UserListConversionType
 },
