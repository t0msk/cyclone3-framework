package Google::Ads::AdWords::v201109_1::AccountError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::AccountError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::AccountError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AccountError from the namespace https://adwords.google.com/api/adwords/account/v201109_1.

Represents possible error codes in AccountService. 
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::AccountError
   reason => $some_value, # AccountError.Reason
 },
