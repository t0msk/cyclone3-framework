package Google::Ads::AdWords::v201109_1::CampaignEstimate;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::Estimate);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'adGroupEstimates' => 'Google::Ads::AdWords::v201109_1::AdGroupEstimate',
    },
    {
...
Google::Ads::AdWords::v201109_1::CampaignEstimate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignEstimate from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::CampaignEstimate
   ...
   adGroupEstimates =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::AdGroupEstimate
 },
