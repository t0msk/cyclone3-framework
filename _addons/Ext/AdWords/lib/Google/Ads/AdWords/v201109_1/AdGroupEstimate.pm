package Google::Ads::AdWords::v201109_1::AdGroupEstimate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'keywordEstimates' => 'Google::Ads::AdWords::v201109_1::KeywordEstimate',
    },
    {
...
Google::Ads::AdWords::v201109_1::AdGroupEstimate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupEstimate from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::AdGroupEstimate
   ...
   keywordEstimates =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::KeywordEstimate
 },
