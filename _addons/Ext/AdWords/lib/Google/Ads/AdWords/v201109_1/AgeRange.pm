package Google::Ads::AdWords::v201109_1::AgeRange;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'ageRangeType' => 'Google::Ads::AdWords::v201109_1::AgeRange::AgeRangeType',
    },
    {
...
Google::Ads::AdWords::v201109_1::AgeRange

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AgeRange from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.

Represents an Age Range criterion. <p>A criterion of this type can only be created using an ID. A criterion of this type is only excludable. 
