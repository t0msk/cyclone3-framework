package Google::Ads::AdWords::v201109_1::Location;
use strict;
use warnings;
...
my %isObsolete_of :ATTR(:get<isObsolete>);
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'isObsolete' => 'SOAP::WSDL::XSD::Typelib::Builtin::boolean',
        'parentLocations' => 'Google::Ads::AdWords::v201109_1::Location',
    },
    {
...
Google::Ads::AdWords::v201109_1::Location

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Location from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.

Represents Location criterion. <p>A criterion of this type can only be created using an ID. A criterion of this type can be either targeted or excluded. 
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::Location
   locationName =>  $some_value, # string
   displayType =>  $some_value, # string
   isObsolete =>  $some_value, # boolean
   parentLocations =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::Location
 },
