package Google::Ads::AdWords::v201109_1::PhoneInteractionBid;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::InteractionBid);
# Variety: sequence
...
Google::Ads::AdWords::v201109_1::PhoneInteractionBid

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PhoneInteractionBid from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
