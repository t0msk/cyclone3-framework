package Google::Ads::AdWords::v201109_1::AdGroupAdReturnValue;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'value' => 'Google::Ads::AdWords::v201109_1::AdGroupAd',
...
Google::Ads::AdWords::v201109_1::AdGroupAdReturnValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupAdReturnValue from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::AdGroupAdReturnValue
   value =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::AdGroupAd
