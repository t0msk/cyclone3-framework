package Google::Ads::AdWords::v201109_1::AdUnionId;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::AdUnionId

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdUnionId from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::AdUnionId
   id =>  $some_value, # long
   AdUnionId__Type =>  $some_value, # string
 },
