package Google::Ads::AdWords::v201109_1::AdScheduleTarget;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::Target);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'dayOfWeek' => 'Google::Ads::AdWords::v201109_1::DayOfWeek',
        'startHour' => 'SOAP::WSDL::XSD::Typelib::Builtin::int',
        'startMinute' => 'Google::Ads::AdWords::v201109_1::MinuteOfHour',
        'endHour' => 'SOAP::WSDL::XSD::Typelib::Builtin::int',
        'endMinute' => 'Google::Ads::AdWords::v201109_1::MinuteOfHour',
...
Google::Ads::AdWords::v201109_1::AdScheduleTarget

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdScheduleTarget from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::AdScheduleTarget
   ...
   bidMultiplier =>  $some_value, # double
 },
