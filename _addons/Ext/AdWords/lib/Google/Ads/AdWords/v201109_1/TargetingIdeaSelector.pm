package Google::Ads::AdWords::v201109_1::TargetingIdeaSelector;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'searchParameters' => 'Google::Ads::AdWords::v201109_1::SearchParameter',
        'ideaType' => 'Google::Ads::AdWords::v201109_1::IdeaType',
        'requestType' => 'Google::Ads::AdWords::v201109_1::RequestType',
        'requestedAttributeTypes' => 'Google::Ads::AdWords::v201109_1::AttributeType',
...
Google::Ads::AdWords::v201109_1::TargetingIdeaSelector

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TargetingIdeaSelector from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::TargetingIdeaSelector
   searchParameters =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::SearchParameter
   ideaType => $some_value, # IdeaType
   requestType => $some_value, # RequestType
   requestedAttributeTypes => $some_value, # AttributeType
