package Google::Ads::AdWords::v201109_1::OperationResult;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::OperationResult

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
OperationResult from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::OperationResult
   OperationResult__Type =>  $some_value, # string
 },
