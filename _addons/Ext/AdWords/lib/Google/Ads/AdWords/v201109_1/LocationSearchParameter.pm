package Google::Ads::AdWords::v201109_1::LocationSearchParameter;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'locations' => 'Google::Ads::AdWords::v201109_1::Location',
    },
    {
...
Google::Ads::AdWords::v201109_1::LocationSearchParameter

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
LocationSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::LocationSearchParameter
   locations =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::Location
 },
