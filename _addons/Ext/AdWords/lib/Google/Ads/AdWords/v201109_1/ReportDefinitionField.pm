package Google::Ads::AdWords::v201109_1::ReportDefinitionField;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'enumValuePairs' => 'Google::Ads::AdWords::v201109_1::EnumValuePair',
    },
    {
...
Google::Ads::AdWords::v201109_1::ReportDefinitionField

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ReportDefinitionField from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::ReportDefinitionField
   fieldName =>  $some_value, # string
   displayFieldName =>  $some_value, # string
   xmlAttributeName =>  $some_value, # string
   fieldType =>  $some_value, # string
   enumValues =>  $some_value, # string
   canSelect =>  $some_value, # boolean
   canFilter =>  $some_value, # boolean
   isEnumType =>  $some_value, # boolean
   isBeta =>  $some_value, # boolean
   enumValuePairs =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::EnumValuePair
 },
