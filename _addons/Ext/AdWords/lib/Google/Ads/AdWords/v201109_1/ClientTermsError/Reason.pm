package Google::Ads::AdWords::v201109_1::ClientTermsError::Reason;
use strict;
use warnings;
...
ClientTermsError.Reason from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
