package Google::Ads::AdWords::v201109_1::JobEvent;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::JobEvent

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
JobEvent from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::JobEvent
   dateTime =>  $some_value, # string
   JobEvent__Type =>  $some_value, # string
 },
