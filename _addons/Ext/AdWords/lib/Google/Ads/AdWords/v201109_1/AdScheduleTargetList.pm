package Google::Ads::AdWords::v201109_1::AdScheduleTargetList;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::TargetList);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'targets' => 'Google::Ads::AdWords::v201109_1::AdScheduleTarget',
    },
    {
...
Google::Ads::AdWords::v201109_1::AdScheduleTargetList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdScheduleTargetList from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::AdScheduleTargetList
   targets =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::AdScheduleTarget
 },
