package Google::Ads::AdWords::v201109_1::ReportDefinitionError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::ReportDefinitionError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::ReportDefinitionError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ReportDefinitionError from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::ReportDefinitionError
   reason => $some_value, # ReportDefinitionError.Reason
 },
