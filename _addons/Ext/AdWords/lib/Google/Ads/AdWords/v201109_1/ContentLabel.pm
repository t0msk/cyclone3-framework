package Google::Ads::AdWords::v201109_1::ContentLabel;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'contentLabelType' => 'Google::Ads::AdWords::v201109_1::ContentLabelType',
    },
    {
...
Google::Ads::AdWords::v201109_1::ContentLabel

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ContentLabel from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::ContentLabel
   contentLabelType => $some_value, # ContentLabelType
 },
