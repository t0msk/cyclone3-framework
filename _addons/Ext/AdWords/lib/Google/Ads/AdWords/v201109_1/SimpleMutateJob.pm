package Google::Ads::AdWords::v201109_1::SimpleMutateJob;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'history' => 'Google::Ads::AdWords::v201109_1::JobEvent',
    },
    {
...
Google::Ads::AdWords::v201109_1::SimpleMutateJob

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
SimpleMutateJob from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::SimpleMutateJob
   ...
   history =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::JobEvent
 },
