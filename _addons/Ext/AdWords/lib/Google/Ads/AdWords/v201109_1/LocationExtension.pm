package Google::Ads::AdWords::v201109_1::LocationExtension;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109_1::AdExtension);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'source' => 'Google::Ads::AdWords::v201109_1::LocationExtension::Source',
...
Google::Ads::AdWords::v201109_1::LocationExtension

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
LocationExtension from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
