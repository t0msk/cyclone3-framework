package Google::Ads::AdWords::v201109_1::PlacementTypeSearchParameter;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'placementTypes' => 'Google::Ads::AdWords::v201109_1::SiteConstants::PlacementType',
    },
    {
...
Google::Ads::AdWords::v201109_1::PlacementTypeSearchParameter

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PlacementTypeSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::PlacementTypeSearchParameter
   placementTypes => $some_value, # SiteConstants.PlacementType
 },
