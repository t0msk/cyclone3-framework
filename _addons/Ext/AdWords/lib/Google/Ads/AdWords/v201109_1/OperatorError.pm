package Google::Ads::AdWords::v201109_1::OperatorError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109_1::OperatorError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109_1::OperatorError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
OperatorError from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::OperatorError
   reason => $some_value, # OperatorError.Reason
 },
