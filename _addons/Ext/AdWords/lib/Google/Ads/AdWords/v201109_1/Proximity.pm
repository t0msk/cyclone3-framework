package Google::Ads::AdWords::v201109_1::Proximity;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'geoPoint' => 'Google::Ads::AdWords::v201109_1::GeoPoint',
        'radiusDistanceUnits' => 'Google::Ads::AdWords::v201109_1::Proximity::DistanceUnits',
        'radiusInUnits' => 'SOAP::WSDL::XSD::Typelib::Builtin::double',
        'address' => 'Google::Ads::AdWords::v201109_1::Address',
    },
    {
...
Google::Ads::AdWords::v201109_1::Proximity

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Proximity from the namespace https://adwords.google.com/api/adwords/cm/v201109_1.

Represents a Proximity Criterion. A proximity is an area within a certain radius of a point with the center point being described by a lat/long pair. The caller may also alternatively provide address fields which will be geocoded into a lat/long pair. Note: If a geoPoint value is provided, the address is not used for calculating the lat/long to target. <p> A criterion of this type is only targetable. 
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109_1::Proximity
   geoPoint =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::GeoPoint
   radiusDistanceUnits => $some_value, # Proximity.DistanceUnits
   radiusInUnits =>  $some_value, # double
   address =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::Address
 },
