...
package Google::Ads::AdWords::v201109_1::MutateJobService::ResponseHeader;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109_1::MutateJobService::ResponseHeader
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109_1::MutateJobService::ResponseHeader->new($data);
