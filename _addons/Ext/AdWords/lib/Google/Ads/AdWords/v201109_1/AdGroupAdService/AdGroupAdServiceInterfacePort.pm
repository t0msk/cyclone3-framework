package Google::Ads::AdWords::v201109_1::AdGroupAdService::AdGroupAdServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201109_1::TypeMaps::AdGroupAdService
    if not Google::Ads::AdWords::v201109_1::TypeMaps::AdGroupAdService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201109_1/AdGroupAdService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201109_1::TypeMaps::AdGroupAdService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201109_1::AdGroupAdService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201109_1::AdGroupAdService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201109_1::AdGroupAdService::mutate )],
        },
        header => {
...
Google::Ads::AdWords::v201109_1::AdGroupAdService::AdGroupAdServiceInterfacePort - SOAP Interface for the AdGroupAdService Web Service

=head1 SYNOPSIS

 use Google::Ads::AdWords::v201109_1::AdGroupAdService::AdGroupAdServiceInterfacePort;
 my $interface = Google::Ads::AdWords::v201109_1::AdGroupAdService::AdGroupAdServiceInterfacePort->new();
...
located at https://adwords.google.com/api/adwords/cm/v201109_1/AdGroupAdService.
...
Returns a L<Google::Ads::AdWords::v201109_1::AdGroupAdService::getResponse|Google::Ads::AdWords::v201109_1::AdGroupAdService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201109_1::AdGroupAdService::mutateResponse|Google::Ads::AdWords::v201109_1::AdGroupAdService::mutateResponse> object.

 $response = $interface->mutate( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201109_1::AdGroupAdOperation
  },,
 );
...
Generated by SOAP::WSDL on Tue Aug 28 17:11:03 2012
