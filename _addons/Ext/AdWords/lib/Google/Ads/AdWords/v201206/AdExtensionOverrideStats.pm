package Google::Ads::AdWords::v201206::AdExtensionOverrideStats;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::AdExtensionOverrideStats

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdExtensionOverrideStats from the namespace https://adwords.google.com/api/adwords/cm/v201206.
