package Google::Ads::AdWords::v201206::ImageAd;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'image' => 'Google::Ads::AdWords::v201206::Image',
...
Google::Ads::AdWords::v201206::ImageAd

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ImageAd from the namespace https://adwords.google.com/api/adwords/cm/v201206.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201206::ImageAd
   image =>  $a_reference_to, # see Google::Ads::AdWords::v201206::Image
