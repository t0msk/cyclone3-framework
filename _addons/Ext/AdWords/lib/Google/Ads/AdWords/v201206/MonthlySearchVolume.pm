package Google::Ads::AdWords::v201206::MonthlySearchVolume;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::MonthlySearchVolume

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
MonthlySearchVolume from the namespace https://adwords.google.com/api/adwords/o/v201206.
