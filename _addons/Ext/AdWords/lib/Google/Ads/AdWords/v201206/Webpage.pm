package Google::Ads::AdWords::v201206::Webpage;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'parameter' => 'Google::Ads::AdWords::v201206::WebpageParameter',
...
Google::Ads::AdWords::v201206::Webpage

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Webpage from the namespace https://adwords.google.com/api/adwords/cm/v201206.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201206::Webpage
   parameter =>  $a_reference_to, # see Google::Ads::AdWords::v201206::WebpageParameter
   criteriaCoverage =>  $some_value, # double
   criteriaSamples =>  $some_value, # string
 },
