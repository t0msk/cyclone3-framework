package Google::Ads::AdWords::v201206::Criterion;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::Criterion

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Criterion from the namespace https://adwords.google.com/api/adwords/cm/v201206.
