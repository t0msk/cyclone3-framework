package Google::Ads::AdWords::v201206::DisplayAdSpec::AdSizeSpec;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'activationOptionFilter' => 'Google::Ads::AdWords::v201206::DisplayAdSpec::ActivationOption',
    },
    {
...
Google::Ads::AdWords::v201206::DisplayAdSpec::AdSizeSpec

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DisplayAdSpec.AdSizeSpec from the namespace https://adwords.google.com/api/adwords/o/v201206.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201206::DisplayAdSpec::AdSizeSpec
   width =>  $some_value, # long
   height =>  $some_value, # long
   activationOptionFilter => $some_value, # DisplayAdSpec.ActivationOption
 },
