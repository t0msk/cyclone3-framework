package Google::Ads::AdWords::v201206::CategoryProductsAndServicesSearchParameter;
use strict;
use warnings;
...
CategoryProductsAndServicesSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201206.
