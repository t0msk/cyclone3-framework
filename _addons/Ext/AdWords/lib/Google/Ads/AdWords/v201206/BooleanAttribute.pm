package Google::Ads::AdWords::v201206::BooleanAttribute;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::BooleanAttribute

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BooleanAttribute from the namespace https://adwords.google.com/api/adwords/o/v201206.
