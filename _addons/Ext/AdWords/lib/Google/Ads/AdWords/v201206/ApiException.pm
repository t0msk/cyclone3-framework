package Google::Ads::AdWords::v201206::ApiException;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201206::ApplicationException);
# Variety: sequence
...
ApiException from the namespace https://adwords.google.com/api/adwords/cm/v201206.
