package Google::Ads::AdWords::v201206::BulkMutateJobService::BulkMutateJobServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201206::TypeMaps::BulkMutateJobService
    if not Google::Ads::AdWords::v201206::TypeMaps::BulkMutateJobService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/job/v201206/BulkMutateJobService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201206::TypeMaps::BulkMutateJobService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201206::BulkMutateJobService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201206::BulkMutateJobService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201206::BulkMutateJobService::mutate )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/job/v201206/BulkMutateJobService.
...
Returns a L<Google::Ads::AdWords::v201206::BulkMutateJobService::getResponse|Google::Ads::AdWords::v201206::BulkMutateJobService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201206::BulkMutateJobService::mutateResponse|Google::Ads::AdWords::v201206::BulkMutateJobService::mutateResponse> object.
...
Generated by SOAP::WSDL on Tue Aug 28 17:10:46 2012
