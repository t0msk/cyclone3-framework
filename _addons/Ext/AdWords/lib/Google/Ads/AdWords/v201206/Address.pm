package Google::Ads::AdWords::v201206::Address;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::Address

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Address from the namespace https://adwords.google.com/api/adwords/cm/v201206.
