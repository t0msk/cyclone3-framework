package Google::Ads::AdWords::v201206::RelatedToQuerySearchParameter;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::RelatedToQuerySearchParameter

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
RelatedToQuerySearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201206.
