...
package Google::Ads::AdWords::v201206::DataService::getCriterionBidLandscape;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::DataService::getCriterionBidLandscape

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getCriterionBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201206.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201206::DataService::getCriterionBidLandscape->new($data);
