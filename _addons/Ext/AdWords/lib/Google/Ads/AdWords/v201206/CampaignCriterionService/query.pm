...
package Google::Ads::AdWords::v201206::CampaignCriterionService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::CampaignCriterionService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201206::CampaignCriterionService::query->new($data);
