package Google::Ads::AdWords::v201206::NumberValue;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::NumberValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
NumberValue from the namespace https://adwords.google.com/api/adwords/cm/v201206.
