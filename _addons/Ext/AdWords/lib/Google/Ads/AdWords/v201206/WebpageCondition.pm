package Google::Ads::AdWords::v201206::WebpageCondition;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operand' => 'Google::Ads::AdWords::v201206::WebpageConditionOperand',
...
Google::Ads::AdWords::v201206::WebpageCondition

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
WebpageCondition from the namespace https://adwords.google.com/api/adwords/cm/v201206.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201206::WebpageCondition
   operand => $some_value, # WebpageConditionOperand
