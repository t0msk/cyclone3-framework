package Google::Ads::AdWords::v201206::ListReturnValue;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::ListReturnValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ListReturnValue from the namespace https://adwords.google.com/api/adwords/cm/v201206.
