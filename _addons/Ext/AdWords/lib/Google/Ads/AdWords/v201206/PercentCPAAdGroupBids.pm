package Google::Ads::AdWords::v201206::PercentCPAAdGroupBids;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::PercentCPAAdGroupBids

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PercentCPAAdGroupBids from the namespace https://adwords.google.com/api/adwords/cm/v201206.
