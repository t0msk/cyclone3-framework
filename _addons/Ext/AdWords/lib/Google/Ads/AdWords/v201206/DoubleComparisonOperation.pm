package Google::Ads::AdWords::v201206::DoubleComparisonOperation;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::DoubleComparisonOperation

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DoubleComparisonOperation from the namespace https://adwords.google.com/api/adwords/o/v201206.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201206::DoubleComparisonOperation
   minimum =>  $some_value, # double
   maximum =>  $some_value, # double
 },
