package Google::Ads::AdWords::v201206::TargetingIdeaService::TargetingIdeaServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201206::TypeMaps::TargetingIdeaService
    if not Google::Ads::AdWords::v201206::TypeMaps::TargetingIdeaService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/o/v201206/TargetingIdeaService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201206::TypeMaps::TargetingIdeaService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201206::TargetingIdeaService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201206::TargetingIdeaService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201206::TargetingIdeaService::getBulkKeywordIdeas )],
        },
        header => {
...
Google::Ads::AdWords::v201206::TargetingIdeaService::TargetingIdeaServiceInterfacePort - SOAP Interface for the TargetingIdeaService Web Service

=head1 SYNOPSIS

 use Google::Ads::AdWords::v201206::TargetingIdeaService::TargetingIdeaServiceInterfacePort;
 my $interface = Google::Ads::AdWords::v201206::TargetingIdeaService::TargetingIdeaServiceInterfacePort->new();
...
located at https://adwords.google.com/api/adwords/o/v201206/TargetingIdeaService.
...
Returns a L<Google::Ads::AdWords::v201206::TargetingIdeaService::getResponse|Google::Ads::AdWords::v201206::TargetingIdeaService::getResponse> object.

 $response = $interface->get( {
    selector =>  $a_reference_to, # see Google::Ads::AdWords::v201206::TargetingIdeaSelector
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201206::TargetingIdeaService::getBulkKeywordIdeasResponse|Google::Ads::AdWords::v201206::TargetingIdeaService::getBulkKeywordIdeasResponse> object.
...
Generated by SOAP::WSDL on Tue Aug 28 17:09:28 2012
