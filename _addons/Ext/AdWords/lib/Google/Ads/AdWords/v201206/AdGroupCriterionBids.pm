package Google::Ads::AdWords::v201206::AdGroupCriterionBids;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::AdGroupCriterionBids

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupCriterionBids from the namespace https://adwords.google.com/api/adwords/cm/v201206.
