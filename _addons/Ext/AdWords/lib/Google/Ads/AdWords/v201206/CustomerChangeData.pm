package Google::Ads::AdWords::v201206::CustomerChangeData;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'changedCampaigns' => 'Google::Ads::AdWords::v201206::CampaignChangeData',
...
Google::Ads::AdWords::v201206::CustomerChangeData

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CustomerChangeData from the namespace https://adwords.google.com/api/adwords/ch/v201206.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201206::CustomerChangeData
   changedCampaigns =>  $a_reference_to, # see Google::Ads::AdWords::v201206::CampaignChangeData
