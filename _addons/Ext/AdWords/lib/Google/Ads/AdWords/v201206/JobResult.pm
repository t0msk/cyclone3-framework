package Google::Ads::AdWords::v201206::JobResult;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'BulkMutateResult' => 'Google::Ads::AdWords::v201206::BulkMutateResult',
        'SimpleMutateResult' => 'Google::Ads::AdWords::v201206::SimpleMutateResult',
    },
    {
...
Google::Ads::AdWords::v201206::JobResult

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
JobResult from the namespace https://adwords.google.com/api/adwords/cm/v201206.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201206::JobResult
   ...
   BulkMutateResult =>  $a_reference_to, # see Google::Ads::AdWords::v201206::BulkMutateResult
   SimpleMutateResult =>  $a_reference_to, # see Google::Ads::AdWords::v201206::SimpleMutateResult
 },
