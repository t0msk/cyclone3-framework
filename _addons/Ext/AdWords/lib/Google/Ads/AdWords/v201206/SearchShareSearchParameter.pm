package Google::Ads::AdWords::v201206::SearchShareSearchParameter;
use strict;
use warnings;
...
SearchShareSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201206.
