package Google::Ads::AdWords::v201206::CampaignCriterionLimitExceeded;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'limitType' => 'Google::Ads::AdWords::v201206::CampaignCriterionLimitExceeded::CriteriaLimitType',
    },
    {
...
Google::Ads::AdWords::v201206::CampaignCriterionLimitExceeded

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignCriterionLimitExceeded from the namespace https://adwords.google.com/api/adwords/cm/v201206.
