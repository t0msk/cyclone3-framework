package Google::Ads::AdWords::v201206::Sitelink;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::Sitelink

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Sitelink from the namespace https://adwords.google.com/api/adwords/cm/v201206.
