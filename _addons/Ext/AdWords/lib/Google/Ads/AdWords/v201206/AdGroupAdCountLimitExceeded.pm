package Google::Ads::AdWords::v201206::AdGroupAdCountLimitExceeded;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::AdGroupAdCountLimitExceeded

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupAdCountLimitExceeded from the namespace https://adwords.google.com/api/adwords/cm/v201206.
