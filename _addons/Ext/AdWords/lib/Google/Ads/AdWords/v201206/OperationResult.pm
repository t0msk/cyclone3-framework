package Google::Ads::AdWords::v201206::OperationResult;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::OperationResult

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
OperationResult from the namespace https://adwords.google.com/api/adwords/cm/v201206.
