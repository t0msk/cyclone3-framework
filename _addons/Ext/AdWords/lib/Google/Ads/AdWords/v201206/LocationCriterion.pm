package Google::Ads::AdWords::v201206::LocationCriterion;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'location' => 'Google::Ads::AdWords::v201206::Location',
...
Google::Ads::AdWords::v201206::LocationCriterion

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
LocationCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201206.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201206::LocationCriterion
   location =>  $a_reference_to, # see Google::Ads::AdWords::v201206::Location
