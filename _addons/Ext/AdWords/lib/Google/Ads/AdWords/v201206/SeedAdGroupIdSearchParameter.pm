package Google::Ads::AdWords::v201206::SeedAdGroupIdSearchParameter;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::SeedAdGroupIdSearchParameter

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
SeedAdGroupIdSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201206.
