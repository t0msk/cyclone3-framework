package Google::Ads::AdWords::v201206::BulkMutateJob;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201206::Job);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    {
        'failureReason' => 'Google::Ads::AdWords::v201206::ApiErrorReason',
        'stats' => 'Google::Ads::AdWords::v201206::JobStats',
        'billingSummary' => 'Google::Ads::AdWords::v201206::BillingSummary',
        'Job__Type' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'id' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'policy' => 'Google::Ads::AdWords::v201206::BulkMutateJobPolicy',
        'request' => 'Google::Ads::AdWords::v201206::BulkMutateRequest',
        'status' => 'Google::Ads::AdWords::v201206::BasicJobStatus',
        'history' => 'Google::Ads::AdWords::v201206::BulkMutateJobEvent',
        'result' => 'Google::Ads::AdWords::v201206::BulkMutateResult',
...
Google::Ads::AdWords::v201206::BulkMutateJob

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BulkMutateJob from the namespace https://adwords.google.com/api/adwords/cm/v201206.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201206::BulkMutateJob
   ...
   request =>  $a_reference_to, # see Google::Ads::AdWords::v201206::BulkMutateRequest
   status => $some_value, # BasicJobStatus
   history =>  $a_reference_to, # see Google::Ads::AdWords::v201206::BulkMutateJobEvent
   result =>  $a_reference_to, # see Google::Ads::AdWords::v201206::BulkMutateResult
