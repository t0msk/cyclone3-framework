package Google::Ads::AdWords::v201206::CampaignAdExtensionReturnValue;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'value' => 'Google::Ads::AdWords::v201206::CampaignAdExtension',
...
Google::Ads::AdWords::v201206::CampaignAdExtensionReturnValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignAdExtensionReturnValue from the namespace https://adwords.google.com/api/adwords/cm/v201206.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201206::CampaignAdExtensionReturnValue
   value =>  $a_reference_to, # see Google::Ads::AdWords::v201206::CampaignAdExtension
