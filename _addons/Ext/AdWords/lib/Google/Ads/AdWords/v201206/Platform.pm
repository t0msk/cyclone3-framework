package Google::Ads::AdWords::v201206::Platform;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::Platform

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Platform from the namespace https://adwords.google.com/api/adwords/cm/v201206.
