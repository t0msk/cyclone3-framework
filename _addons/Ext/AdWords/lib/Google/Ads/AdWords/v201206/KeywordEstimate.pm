package Google::Ads::AdWords::v201206::KeywordEstimate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'min' => 'Google::Ads::AdWords::v201206::StatsEstimate',
        'max' => 'Google::Ads::AdWords::v201206::StatsEstimate',
    },
    {
...
Google::Ads::AdWords::v201206::KeywordEstimate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
KeywordEstimate from the namespace https://adwords.google.com/api/adwords/o/v201206.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201206::KeywordEstimate
   ...
   min =>  $a_reference_to, # see Google::Ads::AdWords::v201206::StatsEstimate
   max =>  $a_reference_to, # see Google::Ads::AdWords::v201206::StatsEstimate
 },
