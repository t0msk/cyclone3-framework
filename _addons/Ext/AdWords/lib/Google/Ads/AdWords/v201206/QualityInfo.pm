package Google::Ads::AdWords::v201206::QualityInfo;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::QualityInfo

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
QualityInfo from the namespace https://adwords.google.com/api/adwords/cm/v201206.
