package Google::Ads::AdWords::v201206::AdParamPolicyError;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::AdParamPolicyError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdParamPolicyError from the namespace https://adwords.google.com/api/adwords/cm/v201206.
