package Google::Ads::AdWords::v201206::Setting;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::Setting

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Setting from the namespace https://adwords.google.com/api/adwords/cm/v201206.
