package Google::Ads::AdWords::v201206::LogicalUserListOperand;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'UserInterest' => 'Google::Ads::AdWords::v201206::UserInterest',
        'UserList' => 'Google::Ads::AdWords::v201206::UserList',
    },
    {
...
Google::Ads::AdWords::v201206::LogicalUserListOperand

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
LogicalUserListOperand from the namespace https://adwords.google.com/api/adwords/cm/v201206.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201206::LogicalUserListOperand
   ...
   UserInterest =>  $a_reference_to, # see Google::Ads::AdWords::v201206::UserInterest
   UserList =>  $a_reference_to, # see Google::Ads::AdWords::v201206::UserList
 },
