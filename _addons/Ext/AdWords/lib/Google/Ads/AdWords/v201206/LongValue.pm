package Google::Ads::AdWords::v201206::LongValue;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::LongValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
LongValue from the namespace https://adwords.google.com/api/adwords/cm/v201206.
