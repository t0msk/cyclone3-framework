package Google::Ads::AdWords::v201206::BulkMutateJobPolicy;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::BulkMutateJobPolicy

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BulkMutateJobPolicy from the namespace https://adwords.google.com/api/adwords/cm/v201206.
