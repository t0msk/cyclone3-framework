package Google::Ads::AdWords::v201206::EntityId;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'type' => 'Google::Ads::AdWords::v201206::EntityId::Type',
...
Google::Ads::AdWords::v201206::EntityId

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
EntityId from the namespace https://adwords.google.com/api/adwords/cm/v201206.
