package Google::Ads::AdWords::v201206::CampaignReturnValue;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'value' => 'Google::Ads::AdWords::v201206::Campaign',
...
Google::Ads::AdWords::v201206::CampaignReturnValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignReturnValue from the namespace https://adwords.google.com/api/adwords/cm/v201206.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201206::CampaignReturnValue
   value =>  $a_reference_to, # see Google::Ads::AdWords::v201206::Campaign
