package Google::Ads::AdWords::v201206::Estimate;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::Estimate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Estimate from the namespace https://adwords.google.com/api/adwords/o/v201206.
