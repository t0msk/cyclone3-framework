package Google::Ads::AdWords::v201206::BatchFailureResult;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201206::OperationResult);
# Variety: sequence
...
Google::Ads::AdWords::v201206::BatchFailureResult

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BatchFailureResult from the namespace https://adwords.google.com/api/adwords/cm/v201206.
