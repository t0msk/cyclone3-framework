package Google::Ads::AdWords::v201206::InStreamAdInfo;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::InStreamAdInfo

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
InStreamAdInfo from the namespace https://adwords.google.com/api/adwords/o/v201206.
