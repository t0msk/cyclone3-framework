package Google::Ads::AdWords::v201206::InvalidGeoLocation;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201206::GeoLocation);
# Variety: sequence
...
Google::Ads::AdWords::v201206::InvalidGeoLocation

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
InvalidGeoLocation from the namespace https://adwords.google.com/api/adwords/cm/v201206.
