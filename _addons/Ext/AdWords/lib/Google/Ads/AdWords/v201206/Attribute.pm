package Google::Ads::AdWords::v201206::Attribute;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::Attribute

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Attribute from the namespace https://adwords.google.com/api/adwords/o/v201206.
