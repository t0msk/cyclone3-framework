package Google::Ads::AdWords::v201206::IntegerAttribute;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::IntegerAttribute

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
IntegerAttribute from the namespace https://adwords.google.com/api/adwords/o/v201206.
