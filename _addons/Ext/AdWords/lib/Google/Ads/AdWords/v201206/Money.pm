package Google::Ads::AdWords::v201206::Money;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201206::ComparableValue);
# Variety: sequence
...
Google::Ads::AdWords::v201206::Money

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Money from the namespace https://adwords.google.com/api/adwords/cm/v201206.
