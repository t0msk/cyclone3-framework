...
package Google::Ads::AdWords::v201206::AdGroupCriterionService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::AdGroupCriterionService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201206::AdGroupCriterionService::query->new($data);
