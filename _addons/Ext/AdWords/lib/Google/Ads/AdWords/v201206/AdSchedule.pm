package Google::Ads::AdWords::v201206::AdSchedule;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::AdSchedule

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdSchedule from the namespace https://adwords.google.com/api/adwords/cm/v201206.
