package Google::Ads::AdWords::v201206::Product;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::Product

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Product from the namespace https://adwords.google.com/api/adwords/cm/v201206.
