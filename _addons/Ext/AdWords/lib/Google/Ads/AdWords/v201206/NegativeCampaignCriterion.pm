package Google::Ads::AdWords::v201206::NegativeCampaignCriterion;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201206::CampaignCriterion);
# Variety: sequence
...
Google::Ads::AdWords::v201206::NegativeCampaignCriterion

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
NegativeCampaignCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201206.
