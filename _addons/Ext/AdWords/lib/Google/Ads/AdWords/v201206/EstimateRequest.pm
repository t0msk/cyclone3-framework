package Google::Ads::AdWords::v201206::EstimateRequest;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::EstimateRequest

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
EstimateRequest from the namespace https://adwords.google.com/api/adwords/o/v201206.
