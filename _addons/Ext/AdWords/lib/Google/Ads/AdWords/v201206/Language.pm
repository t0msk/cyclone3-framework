package Google::Ads::AdWords::v201206::Language;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::Language

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Language from the namespace https://adwords.google.com/api/adwords/cm/v201206.
