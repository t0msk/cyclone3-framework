package Google::Ads::AdWords::v201206::ApplicationException;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::ApplicationException

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ApplicationException from the namespace https://adwords.google.com/api/adwords/cm/v201206.
