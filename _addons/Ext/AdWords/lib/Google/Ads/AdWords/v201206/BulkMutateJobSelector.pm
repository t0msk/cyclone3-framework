package Google::Ads::AdWords::v201206::BulkMutateJobSelector;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201206::JobSelector);
# Variety: sequence
...
Google::Ads::AdWords::v201206::BulkMutateJobSelector

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BulkMutateJobSelector from the namespace https://adwords.google.com/api/adwords/cm/v201206.
