...
package Google::Ads::AdWords::v201206::CampaignService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::CampaignService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201206::CampaignService::query->new($data);
