package Google::Ads::AdWords::v201206::Video;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201206::Media);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'type' => 'Google::Ads::AdWords::v201206::Media::MediaType',
        'referenceId' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'dimensions' => 'Google::Ads::AdWords::v201206::Media_Size_DimensionsMapEntry',
        'urls' => 'Google::Ads::AdWords::v201206::Media_Size_StringMapEntry',
        'mimeType' => 'Google::Ads::AdWords::v201206::Media::MimeType',
...
Google::Ads::AdWords::v201206::Video

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Video from the namespace https://adwords.google.com/api/adwords/cm/v201206.
