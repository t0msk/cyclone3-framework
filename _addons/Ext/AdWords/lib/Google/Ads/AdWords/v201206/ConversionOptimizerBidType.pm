package Google::Ads::AdWords::v201206::ConversionOptimizerBidType;
use strict;
use warnings;
...
ConversionOptimizerBidType from the namespace https://adwords.google.com/api/adwords/cm/v201206.
