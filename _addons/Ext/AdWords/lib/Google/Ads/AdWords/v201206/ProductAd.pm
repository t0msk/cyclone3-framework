package Google::Ads::AdWords::v201206::ProductAd;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::ProductAd

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ProductAd from the namespace https://adwords.google.com/api/adwords/cm/v201206.
