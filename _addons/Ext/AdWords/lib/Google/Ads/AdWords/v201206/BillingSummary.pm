package Google::Ads::AdWords::v201206::BillingSummary;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::BillingSummary

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BillingSummary from the namespace https://adwords.google.com/api/adwords/cm/v201206.
