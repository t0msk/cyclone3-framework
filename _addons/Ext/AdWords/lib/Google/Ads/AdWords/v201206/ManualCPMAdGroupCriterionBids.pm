package Google::Ads::AdWords::v201206::ManualCPMAdGroupCriterionBids;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::ManualCPMAdGroupCriterionBids

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ManualCPMAdGroupCriterionBids from the namespace https://adwords.google.com/api/adwords/cm/v201206.
