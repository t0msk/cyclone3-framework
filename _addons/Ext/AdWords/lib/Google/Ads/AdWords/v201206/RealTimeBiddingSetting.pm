package Google::Ads::AdWords::v201206::RealTimeBiddingSetting;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::RealTimeBiddingSetting

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
RealTimeBiddingSetting from the namespace https://adwords.google.com/api/adwords/cm/v201206.
