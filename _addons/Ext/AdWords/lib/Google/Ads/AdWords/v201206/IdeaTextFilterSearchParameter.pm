package Google::Ads::AdWords::v201206::IdeaTextFilterSearchParameter;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::IdeaTextFilterSearchParameter

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
IdeaTextFilterSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201206.
