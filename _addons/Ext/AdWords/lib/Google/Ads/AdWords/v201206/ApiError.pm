package Google::Ads::AdWords::v201206::ApiError;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::ApiError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ApiError from the namespace https://adwords.google.com/api/adwords/cm/v201206.
