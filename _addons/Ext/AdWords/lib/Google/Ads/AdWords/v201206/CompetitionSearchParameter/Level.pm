package Google::Ads::AdWords::v201206::CompetitionSearchParameter::Level;
use strict;
use warnings;
...
CompetitionSearchParameter.Level from the namespace https://adwords.google.com/api/adwords/o/v201206.
