package Google::Ads::AdWords::v201206::InStreamAdSpec;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'inStreamTypes' => 'Google::Ads::AdWords::v201206::InStreamAdSpec::InStreamType',
...
Google::Ads::AdWords::v201206::InStreamAdSpec

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
InStreamAdSpec from the namespace https://adwords.google.com/api/adwords/o/v201206.
