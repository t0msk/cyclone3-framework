...
package Google::Ads::AdWords::v201206::ManagedCustomerService::mutate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201206::ManagedCustomerOperation',
    },
    {
...
Google::Ads::AdWords::v201206::ManagedCustomerService::mutate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutate from the namespace https://adwords.google.com/api/adwords/mcm/v201206.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201206::ManagedCustomerService::mutate->new($data);
