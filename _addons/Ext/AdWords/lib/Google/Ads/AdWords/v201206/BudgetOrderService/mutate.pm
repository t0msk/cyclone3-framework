...
package Google::Ads::AdWords::v201206::BudgetOrderService::mutate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201206::BudgetOrderOperation',
    },
    {
...
Google::Ads::AdWords::v201206::BudgetOrderService::mutate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutate from the namespace https://adwords.google.com/api/adwords/billing/v201206.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201206::BudgetOrderService::mutate->new($data);
