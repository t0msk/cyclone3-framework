package Google::Ads::AdWords::v201206::JobSelector;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::JobSelector

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
JobSelector from the namespace https://adwords.google.com/api/adwords/cm/v201206.
