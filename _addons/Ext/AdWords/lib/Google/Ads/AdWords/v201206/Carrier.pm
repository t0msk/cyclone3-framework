package Google::Ads::AdWords::v201206::Carrier;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::Carrier

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Carrier from the namespace https://adwords.google.com/api/adwords/cm/v201206.
