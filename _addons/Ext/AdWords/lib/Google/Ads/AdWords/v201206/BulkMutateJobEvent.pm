package Google::Ads::AdWords::v201206::BulkMutateJobEvent;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201206::JobEvent);
# Variety: sequence
...
Google::Ads::AdWords::v201206::BulkMutateJobEvent

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BulkMutateJobEvent from the namespace https://adwords.google.com/api/adwords/cm/v201206.
