package Google::Ads::AdWords::v201206::AdUnionId;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::AdUnionId

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdUnionId from the namespace https://adwords.google.com/api/adwords/cm/v201206.
