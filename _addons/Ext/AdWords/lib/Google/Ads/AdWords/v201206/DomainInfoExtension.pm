package Google::Ads::AdWords::v201206::DomainInfoExtension;
use strict;
use warnings;
...
Google::Ads::AdWords::v201206::DomainInfoExtension

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DomainInfoExtension from the namespace https://adwords.google.com/api/adwords/cm/v201206.
