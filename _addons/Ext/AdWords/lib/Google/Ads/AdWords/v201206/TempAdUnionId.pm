package Google::Ads::AdWords::v201206::TempAdUnionId;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201206::AdUnionId);
# Variety: sequence
...
Google::Ads::AdWords::v201206::TempAdUnionId

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TempAdUnionId from the namespace https://adwords.google.com/api/adwords/cm/v201206.
