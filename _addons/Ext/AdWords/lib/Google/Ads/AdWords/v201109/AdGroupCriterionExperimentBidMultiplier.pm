package Google::Ads::AdWords::v201109::AdGroupCriterionExperimentBidMultiplier;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::AdGroupCriterionExperimentBidMultiplier

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupCriterionExperimentBidMultiplier from the namespace https://adwords.google.com/api/adwords/cm/v201109.
