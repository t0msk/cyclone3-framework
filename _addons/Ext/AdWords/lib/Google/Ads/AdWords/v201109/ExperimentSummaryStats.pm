package Google::Ads::AdWords::v201109::ExperimentSummaryStats;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::ExperimentSummaryStats

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ExperimentSummaryStats from the namespace https://adwords.google.com/api/adwords/cm/v201109.
