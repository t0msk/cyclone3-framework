package Google::Ads::AdWords::v201109::UserInterest;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::UserInterest

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
UserInterest from the namespace https://adwords.google.com/api/adwords/cm/v201109.
