package Google::Ads::AdWords::v201109::UserListMembershipStatus;
use strict;
use warnings;
...
UserListMembershipStatus from the namespace https://adwords.google.com/api/adwords/cm/v201109.
