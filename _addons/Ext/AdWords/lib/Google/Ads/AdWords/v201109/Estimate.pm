package Google::Ads::AdWords::v201109::Estimate;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::Estimate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Estimate from the namespace https://adwords.google.com/api/adwords/o/v201109.
