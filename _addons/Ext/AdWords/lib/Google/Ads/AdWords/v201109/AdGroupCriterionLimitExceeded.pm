package Google::Ads::AdWords::v201109::AdGroupCriterionLimitExceeded;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'limitType' => 'Google::Ads::AdWords::v201109::AdGroupCriterionLimitExceeded::CriteriaLimitType',
    },
    {
...
Google::Ads::AdWords::v201109::AdGroupCriterionLimitExceeded

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupCriterionLimitExceeded from the namespace https://adwords.google.com/api/adwords/cm/v201109.
