package Google::Ads::AdWords::v201109::CategoryProductsAndServicesSearchParameter;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::CategoryProductsAndServicesSearchParameter

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CategoryProductsAndServicesSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201109.
