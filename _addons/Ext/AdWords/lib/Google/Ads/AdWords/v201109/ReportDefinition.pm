package Google::Ads::AdWords::v201109::ReportDefinition;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'selector' => 'Google::Ads::AdWords::v201109::Selector',
        'reportName' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'reportType' => 'Google::Ads::AdWords::v201109::ReportDefinition::ReportType',
        'hasAttachment' => 'SOAP::WSDL::XSD::Typelib::Builtin::boolean',
        'dateRangeType' => 'Google::Ads::AdWords::v201109::ReportDefinition::DateRangeType',
        'downloadFormat' => 'Google::Ads::AdWords::v201109::DownloadFormat',
...
Google::Ads::AdWords::v201109::ReportDefinition

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ReportDefinition from the namespace https://adwords.google.com/api/adwords/cm/v201109.
