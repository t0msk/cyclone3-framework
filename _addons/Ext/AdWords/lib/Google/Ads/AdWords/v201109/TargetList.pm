package Google::Ads::AdWords::v201109::TargetList;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::TargetList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TargetList from the namespace https://adwords.google.com/api/adwords/cm/v201109.
