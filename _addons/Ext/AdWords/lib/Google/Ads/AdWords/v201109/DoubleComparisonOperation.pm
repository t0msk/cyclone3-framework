package Google::Ads::AdWords::v201109::DoubleComparisonOperation;
use strict;
use warnings;
...
DoubleComparisonOperation from the namespace https://adwords.google.com/api/adwords/o/v201109.
