package Google::Ads::AdWords::v201109::RelatedToUrlSearchParameter;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::RelatedToUrlSearchParameter

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
RelatedToUrlSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201109.
