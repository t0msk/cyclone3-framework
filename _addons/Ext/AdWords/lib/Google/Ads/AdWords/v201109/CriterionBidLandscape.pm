package Google::Ads::AdWords::v201109::CriterionBidLandscape;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::CriterionBidLandscape

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CriterionBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201109.
