...
package Google::Ads::AdWords::v201109::MutateJobService::getResult;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'selector' => 'Google::Ads::AdWords::v201109::JobSelector',
    },
    {
...
Google::Ads::AdWords::v201109::MutateJobService::getResult

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getResult from the namespace https://adwords.google.com/api/adwords/cm/v201109.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109::MutateJobService::getResult->new($data);
