package Google::Ads::AdWords::v201109::PercentCPA;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::PercentCPA

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PercentCPA from the namespace https://adwords.google.com/api/adwords/cm/v201109.

Percentage CPA based bidding where user pays a percent of conversions. This bidding strategy is available only to some advertisers. <p>A campaign can only be created with PercentCPA bidding strategy. Existing campaigns with a different bidding strategy cannot be transitioned to PercentCPA. <p>Similarly, once created as a PercentCPA, a campaign cannot be transitioned to any other bidding strategy. 
