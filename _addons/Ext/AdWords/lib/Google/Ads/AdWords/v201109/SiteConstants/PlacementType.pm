package Google::Ads::AdWords::v201109::SiteConstants::PlacementType;
use strict;
use warnings;
...
SiteConstants.PlacementType from the namespace https://adwords.google.com/api/adwords/o/v201109.
