package Google::Ads::AdWords::v201109::ExcludedKeywordSearchParameter;
use strict;
use warnings;
...
ExcludedKeywordSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201109.
