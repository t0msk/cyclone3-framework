...
package Google::Ads::AdWords::v201109::ReportDefinitionService::getReportFields;
use strict;
use warnings;
...
getReportFields from the namespace https://adwords.google.com/api/adwords/cm/v201109.
