package Google::Ads::AdWords::v201109::ExternalRemarketingUserList;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::ExternalRemarketingUserList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ExternalRemarketingUserList from the namespace https://adwords.google.com/api/adwords/cm/v201109.
