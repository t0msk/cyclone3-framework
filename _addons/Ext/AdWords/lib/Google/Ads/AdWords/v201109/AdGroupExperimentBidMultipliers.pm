package Google::Ads::AdWords::v201109::AdGroupExperimentBidMultipliers;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::AdGroupExperimentBidMultipliers

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupExperimentBidMultipliers from the namespace https://adwords.google.com/api/adwords/cm/v201109.
