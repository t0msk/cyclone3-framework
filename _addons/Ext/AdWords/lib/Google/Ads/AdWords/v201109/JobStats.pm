package Google::Ads::AdWords::v201109::JobStats;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::JobStats

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
JobStats from the namespace https://adwords.google.com/api/adwords/cm/v201109.
