package Google::Ads::AdWords::v201109::UserListConversionType::Category;
use strict;
use warnings;
...
UserListConversionType.Category from the namespace https://adwords.google.com/api/adwords/cm/v201109.
