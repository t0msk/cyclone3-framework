package Google::Ads::AdWords::v201109::Stats;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::Stats

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Stats from the namespace https://adwords.google.com/api/adwords/cm/v201109.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109::Stats
   ...
   cost =>  $a_reference_to, # see Google::Ads::AdWords::v201109::Money
   averagePosition =>  $some_value, # double
   averageCpc =>  $a_reference_to, # see Google::Ads::AdWords::v201109::Money
   averageCpm =>  $a_reference_to, # see Google::Ads::AdWords::v201109::Money
   ctr =>  $some_value, # double
   conversions =>  $some_value, # long
   conversionRate =>  $some_value, # double
   costPerConversion =>  $a_reference_to, # see Google::Ads::AdWords::v201109::Money
   conversionsManyPerClick =>  $some_value, # long
   conversionRateManyPerClick =>  $some_value, # double
   costPerConversionManyPerClick =>  $a_reference_to, # see Google::Ads::AdWords::v201109::Money
