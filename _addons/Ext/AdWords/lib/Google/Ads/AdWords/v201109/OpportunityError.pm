package Google::Ads::AdWords::v201109::OpportunityError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201109::OpportunityError::Reason',
    },
    {
...
Google::Ads::AdWords::v201109::OpportunityError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
OpportunityError from the namespace https://adwords.google.com/api/adwords/o/v201109.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109::OpportunityError
   reason => $some_value, # OpportunityError.Reason
 },
