package Google::Ads::AdWords::v201109::UserList;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'status' => 'Google::Ads::AdWords::v201109::UserListMembershipStatus',
        'accessReason' => 'Google::Ads::AdWords::v201109::AccessReason',
        'accountUserListStatus' => 'Google::Ads::AdWords::v201109::AccountUserListStatus',
        'membershipLifeSpan' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'size' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'sizeRange' => 'Google::Ads::AdWords::v201109::SizeRange',
        'type' => 'Google::Ads::AdWords::v201109::UserList::Type',
...
Google::Ads::AdWords::v201109::UserList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
UserList from the namespace https://adwords.google.com/api/adwords/cm/v201109.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109::UserList
   id =>  $some_value, # long
   isReadOnly =>  $some_value, # boolean
   name =>  $some_value, # string
   description =>  $some_value, # string
   status => $some_value, # UserListMembershipStatus
   accessReason => $some_value, # AccessReason
   accountUserListStatus => $some_value, # AccountUserListStatus
   membershipLifeSpan =>  $some_value, # long
   size =>  $some_value, # long
   sizeRange => $some_value, # SizeRange
   type => $some_value, # UserList.Type
   UserList__Type =>  $some_value, # string
 },
