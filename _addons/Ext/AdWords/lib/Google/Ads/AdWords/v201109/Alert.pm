package Google::Ads::AdWords::v201109::Alert;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'alertSeverity' => 'Google::Ads::AdWords::v201109::AlertSeverity',
        'alertType' => 'Google::Ads::AdWords::v201109::AlertType',
        'clientCustomerId' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'details' => 'Google::Ads::AdWords::v201109::Detail',
    },
    {
...
Alert from the namespace https://adwords.google.com/api/adwords/mcm/v201109.
