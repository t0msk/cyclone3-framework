package Google::Ads::AdWords::v201109::CampaignAdExtensionStats;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::CampaignAdExtensionStats

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignAdExtensionStats from the namespace https://adwords.google.com/api/adwords/cm/v201109.
