package Google::Ads::AdWords::v201109::Language;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::Language

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Language from the namespace https://adwords.google.com/api/adwords/cm/v201109.
