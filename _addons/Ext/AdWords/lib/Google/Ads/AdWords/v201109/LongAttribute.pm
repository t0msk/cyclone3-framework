package Google::Ads::AdWords::v201109::LongAttribute;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::LongAttribute

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
LongAttribute from the namespace https://adwords.google.com/api/adwords/o/v201109.
