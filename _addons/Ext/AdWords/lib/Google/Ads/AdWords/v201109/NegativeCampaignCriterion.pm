package Google::Ads::AdWords::v201109::NegativeCampaignCriterion;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109::CampaignCriterion);
# Variety: sequence
...
NegativeCampaignCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201109.
