package Google::Ads::AdWords::v201109::NoStatsPage;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::NoStatsPage

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
NoStatsPage from the namespace https://adwords.google.com/api/adwords/mcm/v201109.
