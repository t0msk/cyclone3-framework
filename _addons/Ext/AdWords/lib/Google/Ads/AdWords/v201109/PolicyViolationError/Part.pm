package Google::Ads::AdWords::v201109::PolicyViolationError::Part;
use strict;
use warnings;
...
PolicyViolationError.Part from the namespace https://adwords.google.com/api/adwords/cm/v201109.
