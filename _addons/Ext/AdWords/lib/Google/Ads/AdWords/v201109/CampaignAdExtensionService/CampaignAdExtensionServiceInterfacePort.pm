package Google::Ads::AdWords::v201109::CampaignAdExtensionService::CampaignAdExtensionServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201109::TypeMaps::CampaignAdExtensionService
    if not Google::Ads::AdWords::v201109::TypeMaps::CampaignAdExtensionService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201109/CampaignAdExtensionService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201109::TypeMaps::CampaignAdExtensionService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201109::CampaignAdExtensionService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201109::CampaignAdExtensionService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201109::CampaignAdExtensionService::mutate )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/cm/v201109/CampaignAdExtensionService.
...
Returns a L<Google::Ads::AdWords::v201109::CampaignAdExtensionService::getResponse|Google::Ads::AdWords::v201109::CampaignAdExtensionService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201109::CampaignAdExtensionService::mutateResponse|Google::Ads::AdWords::v201109::CampaignAdExtensionService::mutateResponse> object.
