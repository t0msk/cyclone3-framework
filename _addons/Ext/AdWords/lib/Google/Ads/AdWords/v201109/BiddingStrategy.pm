package Google::Ads::AdWords::v201109::BiddingStrategy;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::BiddingStrategy

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BiddingStrategy from the namespace https://adwords.google.com/api/adwords/cm/v201109.
