package Google::Ads::AdWords::v201109::BiddingTransitionError::Reason;
use strict;
use warnings;
...
BiddingTransitionError.Reason from the namespace https://adwords.google.com/api/adwords/cm/v201109.
