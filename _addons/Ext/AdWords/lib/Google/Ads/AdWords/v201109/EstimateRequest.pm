package Google::Ads::AdWords::v201109::EstimateRequest;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::EstimateRequest

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
EstimateRequest from the namespace https://adwords.google.com/api/adwords/o/v201109.
