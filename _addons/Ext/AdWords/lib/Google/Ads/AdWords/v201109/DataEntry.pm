package Google::Ads::AdWords::v201109::DataEntry;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::DataEntry

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DataEntry from the namespace https://adwords.google.com/api/adwords/cm/v201109.
