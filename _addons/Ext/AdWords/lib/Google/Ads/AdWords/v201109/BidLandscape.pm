package Google::Ads::AdWords::v201109::BidLandscape;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109::DataEntry);
# Variety: sequence
...
Google::Ads::AdWords::v201109::BidLandscape

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201109.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109::BidLandscape
   ...
   landscapePoints =>  $a_reference_to, # see Google::Ads::AdWords::v201109::BidLandscape::LandscapePoint
 },
