package Google::Ads::AdWords::v201109::GeoLocation;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::GeoLocation

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
GeoLocation from the namespace https://adwords.google.com/api/adwords/cm/v201109.
