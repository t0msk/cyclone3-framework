package Google::Ads::AdWords::v201109::EntityCountLimitExceeded;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::EntityCountLimitExceeded

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
EntityCountLimitExceeded from the namespace https://adwords.google.com/api/adwords/cm/v201109.
