package Google::Ads::AdWords::v201109::BulkMutateJobStats;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201109::JobStats);
# Variety: sequence
...
Google::Ads::AdWords::v201109::BulkMutateJobStats

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BulkMutateJobStats from the namespace https://adwords.google.com/api/adwords/cm/v201109.
