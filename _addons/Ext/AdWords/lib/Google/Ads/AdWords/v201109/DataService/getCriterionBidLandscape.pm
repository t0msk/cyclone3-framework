...
package Google::Ads::AdWords::v201109::DataService::getCriterionBidLandscape;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'serviceSelector' => 'Google::Ads::AdWords::v201109::Selector',
    },
    {
...
Google::Ads::AdWords::v201109::DataService::getCriterionBidLandscape

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getCriterionBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201109.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109::DataService::getCriterionBidLandscape->new($data);
