package Google::Ads::AdWords::v201109::FailureResult;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'cause' => 'Google::Ads::AdWords::v201109::ApiException',
    },
    {
...
Google::Ads::AdWords::v201109::FailureResult

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FailureResult from the namespace https://adwords.google.com/api/adwords/cm/v201109.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109::FailureResult
   cause =>  $a_reference_to, # see Google::Ads::AdWords::v201109::ApiException
 },
