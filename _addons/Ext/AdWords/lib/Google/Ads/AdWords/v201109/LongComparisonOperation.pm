package Google::Ads::AdWords::v201109::LongComparisonOperation;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::LongComparisonOperation

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
LongComparisonOperation from the namespace https://adwords.google.com/api/adwords/o/v201109.
