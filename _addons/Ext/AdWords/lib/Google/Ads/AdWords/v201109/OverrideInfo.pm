package Google::Ads::AdWords::v201109::OverrideInfo;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'LocationOverrideInfo' => 'Google::Ads::AdWords::v201109::LocationOverrideInfo',
    },
    {
...
Google::Ads::AdWords::v201109::OverrideInfo

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
OverrideInfo from the namespace https://adwords.google.com/api/adwords/cm/v201109.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109::OverrideInfo
   ...
   LocationOverrideInfo =>  $a_reference_to, # see Google::Ads::AdWords::v201109::LocationOverrideInfo
 },
