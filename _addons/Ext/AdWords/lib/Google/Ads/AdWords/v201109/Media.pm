package Google::Ads::AdWords::v201109::Media;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::Media

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Media from the namespace https://adwords.google.com/api/adwords/cm/v201109.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109::Media
   ...
   dimensions =>  $a_reference_to, # see Google::Ads::AdWords::v201109::Media_Size_DimensionsMapEntry
   urls =>  $a_reference_to, # see Google::Ads::AdWords::v201109::Media_Size_StringMapEntry
