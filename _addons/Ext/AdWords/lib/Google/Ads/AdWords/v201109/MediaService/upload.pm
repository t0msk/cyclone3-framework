...
package Google::Ads::AdWords::v201109::MediaService::upload;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::MediaService::upload

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
upload from the namespace https://adwords.google.com/api/adwords/cm/v201109.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201109::MediaService::upload->new($data);
