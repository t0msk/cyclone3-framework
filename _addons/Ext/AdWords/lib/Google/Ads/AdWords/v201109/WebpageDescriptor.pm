package Google::Ads::AdWords::v201109::WebpageDescriptor;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::WebpageDescriptor

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
WebpageDescriptor from the namespace https://adwords.google.com/api/adwords/o/v201109.
