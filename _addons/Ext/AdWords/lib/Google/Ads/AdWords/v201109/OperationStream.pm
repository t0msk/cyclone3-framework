package Google::Ads::AdWords::v201109::OperationStream;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'scopingEntityId' => 'Google::Ads::AdWords::v201109::EntityId',
        'operations' => 'Google::Ads::AdWords::v201109::Operation',
    },
    {
...
Google::Ads::AdWords::v201109::OperationStream

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
OperationStream from the namespace https://adwords.google.com/api/adwords/cm/v201109.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109::OperationStream
   scopingEntityId =>  $a_reference_to, # see Google::Ads::AdWords::v201109::EntityId
