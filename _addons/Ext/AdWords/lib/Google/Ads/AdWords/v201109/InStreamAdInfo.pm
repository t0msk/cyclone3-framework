package Google::Ads::AdWords::v201109::InStreamAdInfo;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::InStreamAdInfo

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
InStreamAdInfo from the namespace https://adwords.google.com/api/adwords/o/v201109.
