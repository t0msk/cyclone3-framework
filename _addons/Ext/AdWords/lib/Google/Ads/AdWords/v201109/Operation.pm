package Google::Ads::AdWords::v201109::Operation;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::Operation

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Operation from the namespace https://adwords.google.com/api/adwords/cm/v201109.
