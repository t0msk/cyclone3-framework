package Google::Ads::AdWords::v201109::AdParamPage;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'entries' => 'Google::Ads::AdWords::v201109::AdParam',
...
Google::Ads::AdWords::v201109::AdParamPage

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdParamPage from the namespace https://adwords.google.com/api/adwords/cm/v201109.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201109::AdParamPage
   entries =>  $a_reference_to, # see Google::Ads::AdWords::v201109::AdParam
