package Google::Ads::AdWords::v201109::ListReturnValue;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::ListReturnValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ListReturnValue from the namespace https://adwords.google.com/api/adwords/cm/v201109.
