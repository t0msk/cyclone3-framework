package Google::Ads::AdWords::v201109::DateRange;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::DateRange

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DateRange from the namespace https://adwords.google.com/api/adwords/cm/v201109.
