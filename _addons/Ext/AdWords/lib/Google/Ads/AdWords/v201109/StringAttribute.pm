package Google::Ads::AdWords::v201109::StringAttribute;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::StringAttribute

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
StringAttribute from the namespace https://adwords.google.com/api/adwords/o/v201109.
