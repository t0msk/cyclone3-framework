package Google::Ads::AdWords::v201109::ComparableValue;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::ComparableValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ComparableValue from the namespace https://adwords.google.com/api/adwords/cm/v201109.
