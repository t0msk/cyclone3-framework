package Google::Ads::AdWords::v201109::JobEvent;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::JobEvent

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
JobEvent from the namespace https://adwords.google.com/api/adwords/cm/v201109.
