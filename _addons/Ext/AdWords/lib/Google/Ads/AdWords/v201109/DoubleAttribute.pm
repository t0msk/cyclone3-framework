package Google::Ads::AdWords::v201109::DoubleAttribute;
use strict;
use warnings;
...
Google::Ads::AdWords::v201109::DoubleAttribute

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DoubleAttribute from the namespace https://adwords.google.com/api/adwords/o/v201109.
