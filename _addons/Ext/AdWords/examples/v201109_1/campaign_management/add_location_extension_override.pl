...
use Google::Ads::AdWords::v201109_1::AdExtension;
use Google::Ads::AdWords::v201109_1::AdExtensionOverride;
use Google::Ads::AdWords::v201109_1::AdExtensionOverrideOperation;
use Google::Ads::AdWords::v201109_1::LocationOverrideInfo;
...
sub add_location_extension_override {
  ...
  my $ad_extension = Google::Ads::AdWords::v201109_1::AdExtension->new({
    id => $location_extension_id
  });

  # Create ad extenstion override.
  my $ad_extension_override =
      Google::Ads::AdWords::v201109_1::AdExtensionOverride->new({
        adId => $ad_id, adExtension => $ad_extension,
        # Override info (non-required).
        overrideInfo =>
            Google::Ads::AdWords::v201109_1::OverrideInfo->new({
              LocationOverrideInfo =>
                  Google::Ads::AdWords::v201109_1::LocationOverrideInfo->new({
                    radius => 5,
                    radiusUnits => "MILES"
                  })
            })
  ...
  my $ad_extension_override_operation =
      Google::Ads::AdWords::v201109_1::AdExtensionOverrideOperation->new({
        operator => "ADD",
