...
use Google::Ads::AdWords::v201109_1::Address;
use Google::Ads::AdWords::v201109_1::CampaignAdExtension;
use Google::Ads::AdWords::v201109_1::CampaignAdExtensionOperation;
use Google::Ads::AdWords::v201109_1::GeoLocationSelector;
use Google::Ads::AdWords::v201109_1::LocationExtension;
...
sub add_location_extension {
  ...
  # Create address.
  my $address = Google::Ads::AdWords::v201109_1::Address->new({
  ...
  my $selector = Google::Ads::AdWords::v201109_1::GeoLocationSelector->new({
    addresses => [$address]
  });
  ...
  my $location_extension =
      Google::Ads::AdWords::v201109_1::LocationExtension->new({
  ...
  my $campaign_location_ad_extension =
      Google::Ads::AdWords::v201109_1::CampaignAdExtension->new({
  ...
  # Create operation.
  my $operation =
      Google::Ads::AdWords::v201109_1::CampaignAdExtensionOperation->new({
