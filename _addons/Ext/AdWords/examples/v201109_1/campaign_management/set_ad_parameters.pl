...
use Google::Ads::AdWords::v201109_1::AdParam;
use Google::Ads::AdWords::v201109_1::AdParamOperation;
...
sub set_ad_parameters {
  ...
  my $ad_param1 = Google::Ads::AdWords::v201109_1::AdParam->new({
  ...
  my $ad_param2 = Google::Ads::AdWords::v201109_1::AdParam->new({
    adGroupId => $ad_group_id,
    criterionId => $keyword_id,
    insertionText => "\$40",
    paramIndex => "2",
  ...
  my $ad_param_operation1 =
      Google::Ads::AdWords::v201109_1::AdParamOperation->new({
        operator => "SET",
        operand => $ad_param1
      });
