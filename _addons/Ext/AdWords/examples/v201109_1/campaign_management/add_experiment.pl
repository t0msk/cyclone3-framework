...
use Google::Ads::AdWords::v201109_1::AdGroup;
use Google::Ads::AdWords::v201109_1::AdGroupAd;
use Google::Ads::AdWords::v201109_1::AdGroupAdOperation;
use Google::Ads::AdWords::v201109_1::AdGroupCriterionOperation;
use Google::Ads::AdWords::v201109_1::AdGroupExperimentData;
use Google::Ads::AdWords::v201109_1::AdGroupOperation;
use Google::Ads::AdWords::v201109_1::BidMultiplier;
use Google::Ads::AdWords::v201109_1::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201109_1::BiddableAdGroupCriterionExperimentData;
use Google::Ads::AdWords::v201109_1::Criterion;
use Google::Ads::AdWords::v201109_1::Experiment;
use Google::Ads::AdWords::v201109_1::ExperimentOperation;
use Google::Ads::AdWords::v201109_1::ManualCPCAdGroupCriterionExperimentBidMultiplier;
use Google::Ads::AdWords::v201109_1::ManualCPCAdGroupExperimentBidMultipliers;
...
sub add_experiment {
  ...
  my $end_time = sprintf("%d%02d%02d %02d%02d%02d", ($year + 1900),
      ($mon + 1), $mday, $hour, $min, $sec);
  my $experiment = Google::Ads::AdWords::v201109_1::Experiment->new({
  ...
  my $experiment_operation =
      Google::Ads::AdWords::v201109_1::ExperimentOperation->new({
        operator => "ADD",
        operand => $experiment
      });
  ...
  my $ad_group = Google::Ads::AdWords::v201109_1::AdGroup->new({
    id => $ad_group_id
  });
  ...
  my $experiment_data =
      Google::Ads::AdWords::v201109_1::AdGroupExperimentData->new({
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201109_1::AdGroupOperation->new({
    operand => $ad_group,
    operator => "SET"
  });
  ...
  my $criterion = Google::Ads::AdWords::v201109_1::Criterion->new({
    id => $criterion_id,
  });

  my $ad_group_criterion =
      Google::Ads::AdWords::v201109_1::BiddableAdGroupCriterion->new({
  ...
  # experiment.
  $bid_multiplier =
      Google::Ads::AdWords::v201109_1::ManualCPCAdGroupCriterionExperimentBidMultiplier->new({
        maxCpcMultiplier => Google::Ads::AdWords::v201109_1::BidMultiplier->new({
          multiplier => 1.5
        })
      });
  ...
  $experiment_data =
      Google::Ads::AdWords::v201109_1::BiddableAdGroupCriterionExperimentData->
          new({
            experimentId => $experiment_id,
            experimentDeltaStatus => "MODIFIED",
  ...
  # Create operation.
  $operation =
      Google::Ads::AdWords::v201109_1::AdGroupCriterionOperation->new({
