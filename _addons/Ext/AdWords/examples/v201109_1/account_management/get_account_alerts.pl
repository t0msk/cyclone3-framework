...
use Google::Ads::AdWords::v201109_1::AlertQuery;
use Google::Ads::AdWords::v201109_1::AlertSelector;
...
sub get_account_alerts {
  ...
  # Create alert query.
  my $alert_query = new Google::Ads::AdWords::v201109_1::AlertQuery({
    clientSpec => "ALL",
    filterSpec => "ALL",
  ...
  my $selector = Google::Ads::AdWords::v201109_1::AlertSelector->new({
    query => $alert_query,
    paging => $paging
  });
