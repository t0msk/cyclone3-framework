...
use Google::Ads::AdWords::v201109_1::CustomerSyncSelector;
use Google::Ads::AdWords::v201109_1::DateTimeRange;
...
sub get_account_changes {
  ...
  my $campaigns = $client->CampaignService()->get({
    serviceSelector => Google::Ads::AdWords::v201109_1::Selector->new({
      fields => ["Id"]
    })
  });
  ...
  my $date_time_range = Google::Ads::AdWords::v201109_1::DateTimeRange->new({
    min => $min_date_time,
    max => $max_date_time
  });

  # Create selector.
  my $selector = Google::Ads::AdWords::v201109_1::CustomerSyncSelector->new({
