...
sub pause_ad {
  ...
  my $ad = Google::Ads::AdWords::v201109_1::Ad->new({
    id => $ad_id
  });

  my $ad_group_ad = Google::Ads::AdWords::v201109_1::AdGroupAd->new({
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201109_1::AdGroupAdOperation->new({
    operand => $ad_group_ad,
    operator => "SET"
  });
