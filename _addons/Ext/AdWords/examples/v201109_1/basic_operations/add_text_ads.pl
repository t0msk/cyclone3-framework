...
use Google::Ads::AdWords::v201109_1::Image;
use Google::Ads::AdWords::v201109_1::ImageAd;
use Google::Ads::AdWords::v201109_1::TemplateAd;
use Google::Ads::AdWords::v201109_1::TextAd;
use Google::Ads::AdWords::v201109_1::Video;
...
sub add_text_ads {
  ...
  for(my $i = 0; $i < $num_ads; $i++) {
    ...
    my $text_ad_group_ad = Google::Ads::AdWords::v201109_1::AdGroupAd->new({
    ...
    my $text_ad_group_ad_operation =
      Google::Ads::AdWords::v201109_1::AdGroupAdOperation->new({
        operator => "ADD",
