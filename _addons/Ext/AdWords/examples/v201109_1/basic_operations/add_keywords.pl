...
use Google::Ads::AdWords::v201109_1::Placement;
...
sub add_keywords {
  ...
  for(my $i = 0; $i < $num_keywords; $i++) {
    my $keyword = Google::Ads::AdWords::v201109_1::Keyword->new({
    ...
    my $keyword_biddable_ad_group_criterion =
        Google::Ads::AdWords::v201109_1::BiddableAdGroupCriterion->new({
          ...
          bids => Google::Ads::AdWords::v201109_1::ManualCPCAdGroupCriterionBids->new({
