...
use Google::Ads::AdWords::v201109_1::OrderBy;
...
sub get_keywords {
  ...
  # Create selector.
  my $ad_group_id_predicate = Google::Ads::AdWords::v201109_1::Predicate->new({
    field => "AdGroupId",
    operator => "IN",
    values => [$ad_group_id]
  });
  my $criteria_type_predicate = Google::Ads::AdWords::v201109_1::Predicate->new({
    field => "CriteriaType",
    operator => "EQUALS",
    values => ["KEYWORD"]
  });
  ...
  my $selector = Google::Ads::AdWords::v201109_1::Selector->new({
    ...
    ordering => Google::Ads::AdWords::v201109_1::OrderBy->new({
      field => "AdGroupId",
      sortOrder => "ASCENDING"
    }),
    paging => $paging
    ...
    if ($page->get_entries()) {
      foreach my $ad_group_criterion (@{$page->get_entries()}) {
        ...
        if ($ad_group_criterion->isa(
            "Google::Ads::AdWords::v201109_1::NegativeAdGroupCriterion")) {
