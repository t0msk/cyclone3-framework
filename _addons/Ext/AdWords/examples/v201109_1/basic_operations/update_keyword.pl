...
use Google::Ads::AdWords::v201109_1::ManualCPCAdGroupCriterionBids;
...
sub update_keyword {
  ...
  # Create bids.
  my $bids =
      Google::Ads::AdWords::v201109_1::ManualCPCAdGroupCriterionBids->new({
        maxCpc => Google::Ads::AdWords::v201109_1::Bid->new({
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201109_1::AdGroupCriterionOperation->new({
