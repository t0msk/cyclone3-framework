...
use Google::Ads::AdWords::v201109_1::Predicate;
use Google::Ads::AdWords::v201109_1::RemarketingUserList;
use Google::Ads::AdWords::v201109_1::Selector;
use Google::Ads::AdWords::v201109_1::UserListConversionType;
use Google::Ads::AdWords::v201109_1::UserListOperation;
...
sub add_audience {
  ...
  my $conversion_type =
      Google::Ads::AdWords::v201109_1::UserListConversionType->new({
          name => $name
      });

  # Create remarketing user list.
  my $user_list = Google::Ads::AdWords::v201109_1::RemarketingUserList->new({
    name => $name,
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201109_1::UserListOperation->new({
    operator => "ADD",
    operand => $user_list
  });

  # Add user list.
  my $result = $client->UserListService()->mutate({
  ...
  if ($result->get_value()) {
    ...
    sleep(5);
    my $predicate = Google::Ads::AdWords::v201109_1::Predicate->new({
      field => "Id",
      operator => "IN",
      values => [$user_list->get_id()->get_value()]
    });
    my $selector = Google::Ads::AdWords::v201109_1::Selector->new({
      fields => ["ConversionTypes"],
      predicates => [$predicate]
    });
    my $conversion_trackers_page = $client->UserListService()->get({
    ...
    my $conversion_type_predicate =
        Google::Ads::AdWords::v201109_1::Predicate->new({
          field => "Id",
          operator => "IN",
          values => [$conversion_id]
        });
    $selector = Google::Ads::AdWords::v201109_1::Selector->new({
      fields => ["Id"],
