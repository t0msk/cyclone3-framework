...
use Google::Ads::AdWords::v201109_1::AdWordsConversionTracker;
use Google::Ads::AdWords::v201109_1::ConversionTrackerOperation;
...
sub add_conversion_tracker {
  ...
  my $conversion_tracker =
      Google::Ads::AdWords::v201109_1::AdWordsConversionTracker->new({
        ...
        viewthroughConversionDeDupSearch => 1,
  ...
  my $conversion_operation =
      Google::Ads::AdWords::v201109_1::ConversionTrackerOperation->new({
        operator => "ADD",
