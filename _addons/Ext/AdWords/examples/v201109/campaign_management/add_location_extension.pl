...
use Google::Ads::AdWords::v201109::Address;
use Google::Ads::AdWords::v201109::CampaignAdExtension;
use Google::Ads::AdWords::v201109::CampaignAdExtensionOperation;
use Google::Ads::AdWords::v201109::GeoLocationSelector;
use Google::Ads::AdWords::v201109::LocationExtension;
...
sub add_location_extension {
  ...
  # Create address.
  my $address = Google::Ads::AdWords::v201109::Address->new({
  ...
  my $selector = Google::Ads::AdWords::v201109::GeoLocationSelector->new({
    addresses => [$address]
  });
  ...
  my $location_extension =
      Google::Ads::AdWords::v201109::LocationExtension->new({
  ...
  my $campaign_location_ad_extension =
      Google::Ads::AdWords::v201109::CampaignAdExtension->new({
  ...
  # Create operation.
  my $operation =
      Google::Ads::AdWords::v201109::CampaignAdExtensionOperation->new({
