...
sub validate_text_ad {
  ...
  my $text_ad = Google::Ads::AdWords::v201109::TextAd->new({
  ...
  my $text_ad_group_ad = Google::Ads::AdWords::v201109::AdGroupAd->new({
    adGroupId => $ad_group_id,
    ad => $text_ad
  });

  # Create operations.
  my $operation = Google::Ads::AdWords::v201109::AdGroupAdOperation->new({
