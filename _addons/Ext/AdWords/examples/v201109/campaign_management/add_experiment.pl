...
use Google::Ads::AdWords::v201109::AdGroup;
use Google::Ads::AdWords::v201109::AdGroupAd;
use Google::Ads::AdWords::v201109::AdGroupAdOperation;
use Google::Ads::AdWords::v201109::AdGroupCriterionOperation;
use Google::Ads::AdWords::v201109::AdGroupExperimentData;
use Google::Ads::AdWords::v201109::AdGroupOperation;
use Google::Ads::AdWords::v201109::BidMultiplier;
use Google::Ads::AdWords::v201109::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201109::BiddableAdGroupCriterionExperimentData;
use Google::Ads::AdWords::v201109::Criterion;
use Google::Ads::AdWords::v201109::Experiment;
use Google::Ads::AdWords::v201109::ExperimentOperation;
use Google::Ads::AdWords::v201109::ManualCPCAdGroupCriterionExperimentBidMultiplier;
use Google::Ads::AdWords::v201109::ManualCPCAdGroupExperimentBidMultipliers;
...
sub add_experiment {
  ...
  my $end_time = sprintf("%d%02d%02d %02d%02d%02d", ($year + 1900),
      ($mon + 1), $mday, $hour, $min, $sec);
  my $experiment = Google::Ads::AdWords::v201109::Experiment->new({
  ...
  my $experiment_operation =
      Google::Ads::AdWords::v201109::ExperimentOperation->new({
        operator => "ADD",
        operand => $experiment
      });
  ...
  my $ad_group = Google::Ads::AdWords::v201109::AdGroup->new({
    id => $ad_group_id
  });
  ...
  # experiment.
  my $bid_multiplier =
      Google::Ads::AdWords::v201109::ManualCPCAdGroupExperimentBidMultipliers->
          new({
            maxCpcMultiplier => Google::Ads::AdWords::v201109::BidMultiplier->
                new({
                  multiplier => 1.5
                })
          });
  ...
  my $experiment_data =
      Google::Ads::AdWords::v201109::AdGroupExperimentData->new({
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201109::AdGroupOperation->new({
    operand => $ad_group,
    operator => "SET"
  });
  ...
  my $criterion = Google::Ads::AdWords::v201109::Criterion->new({
    id => $criterion_id,
  });

  my $ad_group_criterion =
      Google::Ads::AdWords::v201109::BiddableAdGroupCriterion->new({
  ...
  # experiment.
  $bid_multiplier =
      Google::Ads::AdWords::v201109::ManualCPCAdGroupCriterionExperimentBidMultiplier->new({
        maxCpcMultiplier => Google::Ads::AdWords::v201109::BidMultiplier->new({
          multiplier => 1.5
        })
      });
  ...
  # Create operation.
  $operation =
      Google::Ads::AdWords::v201109::AdGroupCriterionOperation->new({
