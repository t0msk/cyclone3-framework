...
use Google::Ads::AdWords::v201109::AdGroupCriterion;
use Google::Ads::AdWords::v201109::AdGroupCriterionOperation;
use Google::Ads::AdWords::v201109::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201109::BulkMutateJobPolicy;
use Google::Ads::AdWords::v201109::BulkMutateJobSelector;
use Google::Ads::AdWords::v201109::Keyword;
use Google::Ads::AdWords::v201109::TextAd;
...
sub add_keywords_in_bulk {
  ...
  for (my $i = 1 ; $i < KEYWORD_COUNT; $i++) {
    # Create keyword.
    my $keyword = Google::Ads::AdWords::v201109::Keyword->new({
      matchType => "BROAD"
    });
  ...
  my $job = $client->MutateJobService()->mutate({
        ...
        policy => Google::Ads::AdWords::v201109::BulkMutateJobPolicy->new({
  ...
  my $job_selector = Google::Ads::AdWords::v201109::BulkMutateJobSelector->new({
    jobIds => [$job_id],
    includeStats => 1,
    includeHistory => 1
  });
