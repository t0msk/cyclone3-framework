...
use Google::Ads::AdWords::v201109::CampaignCriterionOperation;
use Google::Ads::AdWords::v201109::Language;
use Google::Ads::AdWords::v201109::Location;
use Google::Ads::AdWords::v201109::Platform;
...
sub add_campaign_targeting_criteria {
  ...
  my $california = Google::Ads::AdWords::v201109::Location->new({
    id => 21137
  });
  push @criteria, $california;
  my $mexico = Google::Ads::AdWords::v201109::Location->new({
    id => 2484 # Mexico
  });
  ...
  my $english = Google::Ads::AdWords::v201109::Language->new({
    id => 1000
  });
  push @criteria, $english;
  my $spanish = Google::Ads::AdWords::v201109::Language->new({
    id => 1003
  });
  push @criteria, $spanish;

  # Create platforms. The IDs can be found in the documentation.
  my $mobile = Google::Ads::AdWords::v201109::Platform->new({
    id => 30001
  });
  push @criteria, $mobile;
  my $tablets = Google::Ads::AdWords::v201109::Platform->new({
    id => 30002
  });
  ...
  foreach my $criterion (@criteria) {
    my $operation =
        Google::Ads::AdWords::v201109::CampaignCriterionOperation->new({
          operator => "ADD",
          operand => Google::Ads::AdWords::v201109::CampaignCriterion->new({
