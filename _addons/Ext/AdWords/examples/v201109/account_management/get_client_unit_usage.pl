...
use Google::Ads::AdWords::v201109::InfoSelector;
...
sub get_client_unit_usage {
  ...
  my $start_of_the_month = sprintf("%d%02d01", ($year + 1900), $mon + 1);
  my $today = sprintf("%d%02d%02d", ($year + 1900), ($mon + 1), $mday);
  my $selector = Google::Ads::AdWords::v201109::InfoSelector->new({
    ...
    dateRange => new Google::Ads::AdWords::v201109::DateRange({
