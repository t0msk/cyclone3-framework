...
use Google::Ads::AdWords::v201109::AdWordsConversionTracker;
use Google::Ads::AdWords::v201109::ConversionTrackerOperation;
...
sub add_conversion_tracker {
  ...
  my $conversion_tracker =
      Google::Ads::AdWords::v201109::AdWordsConversionTracker->new({
  ...
  my $conversion_operation =
      Google::Ads::AdWords::v201109::ConversionTrackerOperation->new({
        operator => "ADD",
