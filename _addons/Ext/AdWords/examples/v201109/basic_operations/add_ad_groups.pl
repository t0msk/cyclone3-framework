...
use Google::Ads::AdWords::v201109::Bid;
use Google::Ads::AdWords::v201109::ManualCPCAdGroupBids;
...
sub add_ad_groups {
  ...
  for (my $i = 0; $i < $num_ad_groups; $i++) {
    ...
    my $ad_group = Google::Ads::AdWords::v201109::AdGroup->new({
      ...
      bids => Google::Ads::AdWords::v201109::ManualCPCAdGroupBids->new({
        keywordMaxCpc => Google::Ads::AdWords::v201109::Bid->new({
    ...
    my $ad_group_operation =
        Google::Ads::AdWords::v201109::AdGroupOperation->new({
          operator => "ADD",
          operand => $ad_group
        });
