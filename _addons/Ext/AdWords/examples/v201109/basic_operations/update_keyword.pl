...
use Google::Ads::AdWords::v201109::ManualCPCAdGroupCriterionBids;
...
sub update_keyword {
  ...
  # Create bids.
  my $bids =
      Google::Ads::AdWords::v201109::ManualCPCAdGroupCriterionBids->new({
        maxCpc => Google::Ads::AdWords::v201109::Bid->new({
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201109::AdGroupCriterionOperation->new({
