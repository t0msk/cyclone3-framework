...
use Google::Ads::AdWords::v201109::AdGroupEstimateRequest;
use Google::Ads::AdWords::v201109::CampaignEstimateRequest;
use Google::Ads::AdWords::v201109::Keyword;
use Google::Ads::AdWords::v201109::KeywordEstimateRequest;
use Google::Ads::AdWords::v201109::Language;
use Google::Ads::AdWords::v201109::Location;
use Google::Ads::AdWords::v201109::TrafficEstimatorSelector;
...
sub estimate_keyword_traffic {
  ...
  my @keywords = (Google::Ads::AdWords::v201109::Keyword->new({
                    text => "mars cruise",
                    matchType => "BROAD"
                  }),
                  Google::Ads::AdWords::v201109::Keyword->new({
                    text => "cheap cruise",
                    matchType => "PHRASE"
                  }),
                  Google::Ads::AdWords::v201109::Keyword->new({
  ...
  my @negative_keywords = (Google::Ads::AdWords::v201109::Keyword->new({
                    text => "moon walk",
                    matchType => "BROAD"
                  }));
  ...
  foreach my $keyword (@keywords) {
    push @keyword_estimate_requests,
         Google::Ads::AdWords::v201109::KeywordEstimateRequest->new({
           keyword => $keyword,
         });
  }
  ...
  my $ad_group_estimate_request =
      Google::Ads::AdWords::v201109::AdGroupEstimateRequest->new({
        keywordEstimateRequests => \@keyword_estimate_requests,
        maxCpc => Google::Ads::AdWords::v201109::Money->new({
          microAmount => 1000000
        })
      });
  ...
  my $campaign_estimate_request =
      Google::Ads::AdWords::v201109::CampaignEstimateRequest->new({
        adGroupEstimateRequests => [$ad_group_estimate_request],
        criteria => [
          Google::Ads::AdWords::v201109::Location->new({
            id => "2840" # US - see http://goo.gl/rlrFr
          }),
          Google::Ads::AdWords::v201109::Language->new({
  ...
  # Create selector.
  my $selector = Google::Ads::AdWords::v201109::TrafficEstimatorSelector->new({
