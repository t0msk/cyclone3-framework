...
use Google::Ads::AdWords::v201206::Paging;
use Google::Ads::AdWords::v201206::RelatedToQuerySearchParameter;
use Google::Ads::AdWords::v201206::TargetingIdeaSelector;
...
sub get_keyword_ideas {
  ...
  # Create selector.
  my $selector = Google::Ads::AdWords::v201206::TargetingIdeaSelector->new({
    requestType => "IDEAS",
    ideaType => "KEYWORD",
  ...
  my $paging = Google::Ads::AdWords::v201206::Paging->new({
    startIndex => 0,
    numberResults => 10
  });
  ...
  my $query_search_parameter =
      Google::Ads::AdWords::v201206::RelatedToQuerySearchParameter->new({
        queries => [$seed_query]
      });

  $selector->set_searchParameters([$query_search_parameter]);
