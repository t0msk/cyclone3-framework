...
use Google::Ads::AdWords::v201206::RemarketingUserList;
use Google::Ads::AdWords::v201206::Selector;
use Google::Ads::AdWords::v201206::UserListConversionType;
use Google::Ads::AdWords::v201206::UserListOperation;
...
sub add_audience {
  ...
  my $conversion_type =
      Google::Ads::AdWords::v201206::UserListConversionType->new({
          name => $name
      });

  # Create remarketing user list.
  my $user_list = Google::Ads::AdWords::v201206::RemarketingUserList->new({
    name => $name,
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201206::UserListOperation->new({
    operator => "ADD",
    operand => $user_list
  });
  ...
  if ($result->get_value()) {
    ...
    sleep(5);
    my $predicate = Google::Ads::AdWords::v201206::Predicate->new({
      field => "Id",
      operator => "IN",
    ...
    my $conversion_type_predicate =
        Google::Ads::AdWords::v201206::Predicate->new({
          field => "Id",
          operator => "IN",
          values => [$conversion_id]
        });
    $selector = Google::Ads::AdWords::v201206::Selector->new({
      fields => ["Id"],
