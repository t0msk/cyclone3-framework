...
use Google::Ads::AdWords::v201206::AdWordsConversionTracker;
use Google::Ads::AdWords::v201206::ConversionTrackerOperation;
...
sub add_conversion_tracker {
  ...
  my $conversion_tracker =
      Google::Ads::AdWords::v201206::AdWordsConversionTracker->new({
  ...
  my $conversion_operation =
      Google::Ads::AdWords::v201206::ConversionTrackerOperation->new({
        operator => "ADD",
