...
use Google::Ads::AdWords::v201206::Image;
use Google::Ads::AdWords::v201206::ImageAd;
use Google::Ads::AdWords::v201206::TemplateAd;
use Google::Ads::AdWords::v201206::TextAd;
use Google::Ads::AdWords::v201206::Video;
...
sub add_text_ads {
  ...
  for(my $i = 0; $i < $num_ads; $i++) {
    # Create text ad.
    my $text_ad = Google::Ads::AdWords::v201206::TextAd->new({
    ...
    my $text_ad_group_ad = Google::Ads::AdWords::v201206::AdGroupAd->new({
    ...
    my $text_ad_group_ad_operation =
      Google::Ads::AdWords::v201206::AdGroupAdOperation->new({
        operator => "ADD",
