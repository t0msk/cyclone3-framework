...
use Google::Ads::AdWords::v201206::ManualCPCAdGroupCriterionBids;
use Google::Ads::AdWords::v201206::Placement;
  ...
  for(my $i = 0; $i < $num_keywords; $i++) {
    ...
    my $keyword_biddable_ad_group_criterion =
        Google::Ads::AdWords::v201206::BiddableAdGroupCriterion->new({
          ...
          bids => Google::Ads::AdWords::v201206::ManualCPCAdGroupCriterionBids->new({
            maxCpc => Google::Ads::AdWords::v201206::Bid->new({
