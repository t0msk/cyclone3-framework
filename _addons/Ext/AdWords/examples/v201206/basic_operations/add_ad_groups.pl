...
use Google::Ads::AdWords::v201206::Bid;
use Google::Ads::AdWords::v201206::ManualCPCAdGroupBids;
use Google::Ads::AdWords::v201206::Money;
use Google::Ads::AdWords::v201206::TargetingSetting;
use Google::Ads::AdWords::v201206::TargetingSettingDetail;
...
sub add_ad_groups {
  ...
  for (my $i = 0; $i < $num_ad_groups; $i++) {
    ...
    my $ad_group = Google::Ads::AdWords::v201206::AdGroup->new({
      ...
      bids => Google::Ads::AdWords::v201206::ManualCPCAdGroupBids->new({
        keywordMaxCpc => Google::Ads::AdWords::v201206::Bid->new({
      ...
      settings => [
        ...
        Google::Ads::AdWords::v201206::TargetingSetting->new({
          details => [
            # Restricting to serve ads that match your ad group placements.
            Google::Ads::AdWords::v201206::TargetingSettingDetail->new({
    ...
    my $ad_group_operation =
        Google::Ads::AdWords::v201206::AdGroupOperation->new({
          operator => "ADD",
          operand => $ad_group
        });
