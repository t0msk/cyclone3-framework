...
use Google::Ads::AdWords::v201206::AdGroup;
use Google::Ads::AdWords::v201206::AdGroupAd;
use Google::Ads::AdWords::v201206::AdGroupAdOperation;
use Google::Ads::AdWords::v201206::AdGroupCriterionOperation;
use Google::Ads::AdWords::v201206::AdGroupExperimentData;
use Google::Ads::AdWords::v201206::AdGroupOperation;
use Google::Ads::AdWords::v201206::BidMultiplier;
use Google::Ads::AdWords::v201206::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201206::BiddableAdGroupCriterionExperimentData;
use Google::Ads::AdWords::v201206::Criterion;
use Google::Ads::AdWords::v201206::Experiment;
use Google::Ads::AdWords::v201206::ExperimentOperation;
use Google::Ads::AdWords::v201206::ManualCPCAdGroupCriterionExperimentBidMultiplier;
use Google::Ads::AdWords::v201206::ManualCPCAdGroupExperimentBidMultipliers;
...
sub add_experiment {
  ...
  my $end_time = sprintf("%d%02d%02d %02d%02d%02d", ($year + 1900),
      ($mon + 1), $mday, $hour, $min, $sec);
  my $experiment = Google::Ads::AdWords::v201206::Experiment->new({
  ...
  my $experiment_operation =
      Google::Ads::AdWords::v201206::ExperimentOperation->new({
        operator => "ADD",
        operand => $experiment
      });
  ...
  my $ad_group = Google::Ads::AdWords::v201206::AdGroup->new({
    id => $ad_group_id
  });
  ...
  # experiment.
  my $bid_multiplier =
      Google::Ads::AdWords::v201206::ManualCPCAdGroupExperimentBidMultipliers->
          new({
            maxCpcMultiplier => Google::Ads::AdWords::v201206::BidMultiplier->
                new({
                  multiplier => 1.5
                })
          });
  ...
  my $experiment_data =
      Google::Ads::AdWords::v201206::AdGroupExperimentData->new({
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201206::AdGroupOperation->new({
    operand => $ad_group,
    operator => "SET"
  });
  ...
  my $criterion = Google::Ads::AdWords::v201206::Criterion->new({
    id => $criterion_id,
  });

  my $ad_group_criterion =
      Google::Ads::AdWords::v201206::BiddableAdGroupCriterion->new({
  ...
  # experiment.
  $bid_multiplier =
      Google::Ads::AdWords::v201206::ManualCPCAdGroupCriterionExperimentBidMultiplier->new({
        maxCpcMultiplier => Google::Ads::AdWords::v201206::BidMultiplier->new({
          multiplier => 1.5
        })
      });
  ...
  $experiment_data =
      Google::Ads::AdWords::v201206::BiddableAdGroupCriterionExperimentData->
          new({
            experimentId => $experiment_id,
            experimentDeltaStatus => "MODIFIED",
  ...
  # Create operation.
  $operation =
      Google::Ads::AdWords::v201206::AdGroupCriterionOperation->new({
