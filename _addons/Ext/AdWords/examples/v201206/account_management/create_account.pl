...
use Google::Ads::AdWords::v201206::ManagedCustomer;
use Google::Ads::AdWords::v201206::ManagedCustomerOperation;
...
sub create_account {
  ...
  my $account = Google::Ads::AdWords::v201206::ManagedCustomer->new({
  ...
  my $operation = Google::Ads::AdWords::v201206::ManagedCustomerOperation->new({
    operator        => "ADD",
    operand         => $account
  });
