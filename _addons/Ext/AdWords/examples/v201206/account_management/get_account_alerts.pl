...
use Google::Ads::AdWords::v201206::AlertQuery;
use Google::Ads::AdWords::v201206::AlertSelector;
...
sub get_account_alerts {
  ...
  # Create alert query.
  my $alert_query = new Google::Ads::AdWords::v201206::AlertQuery({
    clientSpec => "ALL",
    filterSpec => "ALL",
  ...
  my $selector = Google::Ads::AdWords::v201206::AlertSelector->new({
    query => $alert_query,
    paging => $paging
  });
